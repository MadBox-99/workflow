...
ge.prototype = {
    ...
    addBefore: function (t, e, n) {
        var r = this.remove(e),
            o = r.content.slice(),
            i = r.find(t);
        return (o.splice(i == -1 ? o.length : i, 0, e, n), new ge(o));
    },
    forEach: function (t) {
        for (var e = 0; e < this.content.length; e += 2)
    ...
    prepend: function (t) {
        return (
            (t = ge.from(t)),
            t.size ? new ge(t.content.concat(this.subtract(t).content)) : this
        );
    },
    append: function (t) {
        return (
            (t = ge.from(t)),
            t.size ? new ge(this.subtract(t).content.concat(t.content)) : this
        );
    },
    subtract: function (t) {
        var e = this;
...
function ba(t, e, n) {
    for (let r = 0; ; r++) {
        ...
        if (o.content.size || i.content.size) {
            let s = ba(o.content, i.content, n + 1);
            if (s != null) return s;
        }
        n += o.nodeSize;
    }
...
function wa(t, e, n, r) {
    for (let o = t.childCount, i = e.childCount; ; ) {
        ...
        if (s.content.size || l.content.size) {
            let c = wa(s.content, l.content, n - 1, r - 1);
            if (c) return c;
        }
        ((n -= a), (r -= a));
    }
...
var v = class t {
    ...
    findDiffEnd(e, n = this.size, r = e.size) {
        return wa(this, e, n, r);
    }
    findIndex(e) {
        if (e == 0) return Ar(0, e);
        if (e == this.size) return Ar(this.content.length, e);
        if (e > this.size || e < 0)
            throw new RangeError(`Position ${e} outside of fragment (${this})`);
        for (let n = 0, r = 0; ; n++) {
            let o = this.child(n),
                i = r + o.nodeSize;
            if (i >= e) return i == e ? Ar(n + 1, i) : Ar(n, r);
            r = i;
        }
    }
    toString() {
...
v.empty = new v([], 0);
var Mi = { index: 0, offset: 0 };
function Ar(t, e) {
    return ((Mi.index = t), (Mi.offset = e), Mi);
}
function Nr(t, e) {
    if (t === e) return !0;
    ...
    if (n) {
        ...
        for (let r = 0; r < t.length; r++) if (!Nr(t[r], e[r])) return !1;
    } else {
        for (let r in t) if (!(r in e) || !Nr(t[r], e[r])) return !1;
...
var J = class t {
    ...
    eq(e) {
        return this == e || (this.type == e.type && Nr(this.attrs, e.attrs));
    }
    toJSON() {
...
var Ft = class extends Error {},
    E = class t {
        ...
        removeBetween(e, n) {
            return new t(
                xa(this.content, e + this.openStart, n + this.openStart),
                this.openStart,
                this.openEnd,
            );
        }
        ...
        static fromJSON(e, n) {
            ...
            return new t(v.fromJSON(e, n.content), r, o);
        }
...
function xa(t, e, n) {
    ...
    return t.replaceChild(r, i.copy(xa(i.content, e - o - 1, n - o - 1)));
}
function ka(t, e, n, r) {
...
function Sa(t, e, n, r) {
    ...
    if (o == e.index(r) && r < t.depth - n.openStart) {
        ...
        if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
            ...
            let { start: s, end: l } = lp(n, t);
            return $t(i, va(t, s, l, e, r));
        }
    else return $t(i, Or(t, e, r));
}
function Ca(t, e) {
    if (!e.type.compatibleContent(t.type))
        throw new Ft("Cannot join " + e.type.name + " onto " + t.type.name);
}
function Ai(t, e, n) {
    let r = t.node(n);
    return (Ca(r, e.node(n)), r);
}
function Ht(t, e) {
    let n = e.length - 1;
...
function zn(t, e, n, r) {
    ...
    t &&
        ((i = t.index(n)),
        t.depth > n ? i++ : t.textOffset && (Ht(t.nodeAfter, r), i++));
    for (let l = i; l < s; l++) Ht(o.child(l), r);
...
function va(t, e, n, r, o) {
    let i = t.depth > o && Ai(t, e, o + 1),
        s = r.depth > o && Ai(n, r, o + 1),
        l = [];
    return (
        zn(null, t, o, l),
        i && s && e.index(o) == n.index(o)
            ? (Ca(i, s), Ht($t(i, va(t, e, n, r, o + 1)), l))
            : (i && Ht($t(i, Or(t, e, o + 1)), l),
              zn(e, n, o, l),
              s && Ht($t(s, Or(n, r, o + 1)), l)),
        zn(r, null, o, l),
        new v(l)
    );
}
function Or(t, e, n) {
    let r = [];
    if ((zn(null, t, n, r), t.depth > n)) {
        let o = Ai(t, e, n + 1);
        Ht($t(o, Or(t, e, n + 1)), r);
    }
    return (zn(e, null, n, r), new v(r));
}
function lp(t, e) {
...
var Rr = class t {
        ...
        static resolveCached(e, n) {
            ...
            else ca.set(e, (r = new Ei()));
            let o = (r.elts[r.i] = t.resolve(e, n));
            return ((r.i = (r.i + 1) % ap), o);
        }
    },
    Ei = class {
        constructor() {
    ...
    ie = class t {
        constructor(e, n, r, o = J.none) {
            ((this.type = e),
                (this.attrs = n),
                (this.marks = o),
                (this.content = r || v.empty));
        }
        get children() {
        ...
        hasMarkup(e, n, r) {
            return (
                this.type == e &&
                Nr(this.attrs, n || e.defaultAttrs || cp) &&
                J.sameSet(this.marks, r || J.none)
            );
        }
        copy(e = null) {
        ...
        replace(e, n, r) {
            return sp(this.resolve(e), this.resolve(n), r);
        }
        nodeAt(e) {
            for (let n = this; ; ) {
        ...
        canReplace(e, n, r = v.empty, o = 0, i = r.childCount) {
...
function gp(t) {
    ...
    function n(r) {
        ...
        let i = (e[r.join(",")] = new _t(r.indexOf(t.length - 1) > -1));
...
function Ra(t, e) {
    let n = Object.create(null);
    if (e) for (let r in e) n[r] = new Ri(t, r, e[r]);
    return n;
}
var Dr = class t {
    constructor(e, n, r) {
        ((this.name = e),
            ...
            (this.attrs = Ra(e, r.attrs)),
            (this.defaultAttrs = Ea(this.attrs)),
    ...
    create(e = null, n, r) {
        ...
        return new ie(this, this.computeAttrs(e), v.from(n), J.setFrom(r));
    }
    createChecked(e = null, n, r) {
        return (
            (n = v.from(n)),
            this.checkContent(n),
            new ie(this, this.computeAttrs(e), n, J.setFrom(r))
        );
    }
    createAndFill(e = null, n, r) {
        ...
        return i ? new ie(this, e, n.append(i), J.setFrom(r)) : null;
    }
    validContent(e) {
    ...
    checkAttrs(e) {
        Oa(this.attrs, e, "node", this.name);
    }
    allowsMarkType(e) {
...
var Ri = class {
    ...
    $n = class t {
        ...
        checkAttrs(e) {
            Oa(this.attrs, e, "mark", this.name);
        }
        excludes(e) {
    ...
    fn = class {
        constructor(e) {
            ...
            ((n.nodes = vi.from(e.nodes)),
                (n.marks = vi.from(e.marks || {})),
                (this.nodes = Dr.compile(this.spec.nodes, this)),
                (this.marks = $n.compile(this.spec.marks, this)));
            let r = Object.create(null);
            ...
            for (let o in this.marks) {
                let i = this.marks[o],
                    s = i.spec.excludes;
                i.excluded =
                    s == null ? [i] : s == "" ? [] : fa(this, s.split(" "));
            }
            ((this.nodeFromJSON = (o) => ie.fromJSON(this, o)),
                (this.markFromJSON = (o) => J.fromJSON(this, o)),
        ...
        text(e, n) {
            ...
            return new Ni(r, r.defaultAttrs, e, J.setFrom(n));
        }
        mark(e, n) {
...
var Xe = class t {
        ...
        parse(e, n = {}) {
            let r = new Ir(this, n, !1);
            return (r.addAll(e, J.none, n.from, n.to), r.finish());
        }
        parseSlice(e, n = {}) {
            let r = new Ir(this, n, !0);
            return (r.addAll(e, J.none, n.from, n.to), E.maxOpen(r.finish()));
        }
        matchTag(e, n, r) {
            for (
...
var un = class {
        constructor(e, n, r, o, i, s) {
            ((this.type = e),
                ...
                (this.match = i || (s & Hn ? null : e.contentMatch)));
        }
        findWrapping(e) {
            if (!this.match) {
                if (!this.type) return [];
        ...
        finish(e) {
            ...
            return (
                !e &&
                    this.match &&
                    (n = n.append(this.match.fillBefore(v.empty, !0))),
        ...
        inlineContext(e) {
            return this.type
                ...
                : this.content.length
                  ...
                  : e.parentNode &&
                    !Da.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
        }
    },
    Ir = class {
        constructor(e, n, r) {
            ...
            let o = n.topNode,
                i,
                s = ha(null, n.preserveWhitespace, 0) | (r ? Hn : 0);
            (o
                ? (i = new un(
                      o.type,
                      o.attrs,
                ...
                : r
                  ? (i = new un(null, null, J.none, !0, null, s))
                  : (i = new un(
        ...
        addTextNode(e, n) {
            let r = e.nodeValue,
                ...
                i =
                    o.options & Di
                        ? "full"
                        : this.localPreserveWS || (o.options & Fn) > 0,
...
`,
        ...
        addElement(e, n, r) {
            ...
            let s = e.nodeName.toLowerCase(),
                l;
            Ia.hasOwnProperty(s) && this.parser.normalizeLists && Sp(e);
            let a =
                (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
                (l = this.parser.matchTag(e, this, r));
            e: if (a ? a.ignore : kp.hasOwnProperty(s))
...
`),
            ...
            if (o) {
                ...
                for (let l of o.concat(e.marks))
                    (i.type
                        ...
                        : ma(l.type, e.type)) && (s = l.addToSet(s));
        ...
        enterInner(e, n, r, o = !1, i) {
            ...
            let l = ha(e, i, s.options);
            s.options & Hn && s.content.length == 0 && (l |= Hn);
            let a = J.none;
            return (
                (r = r.filter((c) =>
                    (s.type ? s.type.allowsMarkType(c.type) : ma(c.type, e))
                        ? ((a = c.addToSet(a)), !1)
                        : !0,
                )),
                this.nodes.push(new un(e, n, a, o, null, l)),
                this.open++,
                r
            );
        }
        ...
        sync(e) {
            for (let n = this.open; n >= 0; n--) {
                ...
                this.localPreserveWS && (this.nodes[n].options |= Fn);
            }
            return !1;
        }
        get currentPos() {
...
var ct = class t {
    ...
    serializeFragment(e, n = {}, r) {
        r || (r = Ti(n).createDocumentFragment());
        let o = r,
            i = [];
        return (
            e.forEach((s) => {
    ...
    serializeMark(e, n, r = {}) {
        ...
        return o && Er(Ti(r), o(e, n), null, e.attrs);
    }
...
function vp(t) {
    let e = ya.get(t);
    return (e === void 0 && ya.set(t, (e = Mp(t))), e);
}
function Mp(t) {
    let e = null;
    function n(r) {
...
function Er(t, e, n, r) {
    ...
    for (let u = d; u < e.length; u++) {
        ...
        if (f === 0) {
            ...
            let { dom: h, contentDOM: p } = Er(t, f, n, r);
...
var Ha = 1,
    ...
    Wn = class {
        ...
        get deletedBefore() {
            return (this.delInfo & (Ha | Pr)) > 0;
        }
        get deletedAfter() {
            return (this.delInfo & ($a | Pr)) > 0;
        }
        get deletedAcross() {
    ...
    dt = class t {
        ...
        _map(e, n, r) {
            ...
            for (let l = 0; l < this.ranges.length; l += 3) {
                ...
                if (e <= u) {
                    let f = c ? (e == a ? -1 : e == u ? 1 : n) : n,
                        h = a + o + (f < 0 ? 0 : d);
                    if (r) return h;
                    let p = e == (n < 0 ? a : u) ? null : Tp(l / 3, e - a),
                        m = e == a ? $a : e == u ? Ha : Pr;
                    return (
                        (n < 0 ? e != a : e != u) && (m |= Fa),
                        new Wn(h, m, p)
            ...
            return r ? e + o : new Wn(e + o, 0, null);
        }
        touches(e, n) {
            let r = 0,
                o = Pa(n),
    ...
    ue = class t {
        ...
        static fromReplace(e, n, r, o) {
            try {
                ...
                if (i instanceof Ft) return t.fail(i.message);
                throw i;
            }
        }
    };
function Hi(t, e, n) {
    ...
    for (let o = 0; o < t.childCount; o++) {
        let i = t.child(o);
        (i.content.size && (i = i.copy(Hi(i.content, e, i))),
            i.isInline && (i = e(i, n, o)),
            r.push(i));
    }
    return v.fromArray(r);
}
var Un = class t extends ce {
    constructor(e, n, r) {
...
ce.jsonID("addMark", Un);
var ut = class t extends ce {
    constructor(e, n, r) {
        (super(), (this.from = e), (this.to = n), (this.mark = r));
    }
    apply(e) {
...
ce.jsonID("removeMark", ut);
var Kn = class t extends ce {
    constructor(e, n) {
        (super(), (this.pos = e), (this.mark = n));
    }
    apply(e) {
        let n = e.nodeAt(this.pos);
        if (!n) return ue.fail("No node at mark step's position");
        let r = n.type.create(n.attrs, null, this.mark.addToSet(n.marks));
        return ue.fromReplace(
            e,
            this.pos,
            this.pos + 1,
            new E(v.from(r), 0, n.isLeaf ? 0 : 1),
        );
    }
    invert(e) {
        let n = e.nodeAt(this.pos);
...
ce.jsonID("addNodeMark", Kn);
var hn = class t extends ce {
    constructor(e, n) {
        (super(), (this.pos = e), (this.mark = n));
    }
    apply(e) {
...
ce.jsonID("removeNodeMark", hn);
var ye = class t extends ce {
    ...
    apply(e) {
        return this.structure && Bi(e, this.from, this.to)
            ? ue.fail("Structure replace would overwrite content")
            : ue.fromReplace(e, this.from, this.to, this.slice);
    }
    getMap() {
...
ce.jsonID("replace", ye);
var se = class t extends ce {
    ...
    apply(e) {
        if (
            this.structure &&
            (Bi(e, this.from, this.gapFrom) || Bi(e, this.gapTo, this.to))
        )
            return ue.fail("Structure gap-replace would overwrite content");
        let n = e.slice(this.gapFrom, this.gapTo);
        if (n.openStart || n.openEnd) return ue.fail("Gap is not a flat range");
        let r = this.slice.insertAt(this.insert, n.content);
        return r
            ? ue.fromReplace(e, this.from, this.to, r)
            : ue.fail("Content does not fit in gap");
    }
    getMap() {
        return new dt([
            this.from,
            ...
            for (let m = 0; m < u.length; m++)
                u[m].isInSet(p) ||
                    (s && s.to == f && s.mark.eq(u[m])
                        ? (s.to = h)
                        : o.push((s = new ut(f, h, u[m]))));
            l && l.to == f ? (l.to = h) : i.push((l = new Un(f, h, r)));
        }
    }),
...
function Np(t, e, n, r) {
    ...
    (t.doc.nodesBetween(e, n, (s, l) => {
        ...
        o.forEach((s) => t.step(new ut(s.from, s.to, s.style))));
}
function $i(t, e, n, r = n.contentMatch, o = !0) {
    ...
    for (let a = 0; a < i.childCount; a++) {
        ...
        if (!u) s.push(new ye(l, d, E.empty));
        else {
            r = u;
            for (let f = 0; f < c.marks.length; f++)
                n.allowsMarkType(c.marks[f].type) ||
                    t.step(new ut(l, d, c.marks[f]));
            if (o && c.isText && n.whitespace != "pre") {
                ...
                for (; (f = h.exec(c.text)); )
                    (p ||
                        (p = new E(
                            v.from(n.schema.text(" ", n.allowedMarks(c.marks))),
                            0,
                            0,
                        )),
                        s.push(
                            new ye(l + f.index, l + f.index + f[0].length, p),
                        ));
            }
        }
        l = d;
...
function ft(t) {
    ...
    for (let r = t.depth, o = 0, i = 0; ; --r) {
        ...
        if (r == 0 || s.type.spec.isolating || !Op(s, l, a)) break;
...
function Rp(t, e, n) {
    ...
    for (let p = i, m = !1; p > n; p--)
        m || r.index(p) > 0
            ? ((m = !0), (d = v.from(r.node(p).copy(d))), u++)
            : a--;
    let f = v.empty,
        h = 0;
    for (let p = i, m = !1; p > n; p--)
        m || o.after(p + 1) < o.end(p)
            ? ((m = !0), (f = v.from(o.node(p).copy(f))), h++)
            : c++;
    t.step(new se(a, c, s, l, new E(d.append(f), u, h), d.size - u, !0));
}
function mn(t, e, n = null, r = t) {
    let o = Dp(t, e),
        i = o && Ip(r, e);
    return i ? o.map(La).concat({ type: e, attrs: n }).concat(i.map(La)) : null;
}
function La(t) {
...
function Pp(t, e, n) {
    ...
    let o = e.start,
        i = e.end;
    t.step(new se(o, i, o, i, new E(r, 0, 0), n.length, !0));
}
function Lp(t, e, n, r, o) {
    ...
    t.doc.nodesBetween(e, n, (s, l) => {
        ...
        if (
            s.isTextblock &&
            !s.hasMarkup(r, a) &&
            Bp(t.doc, t.mapping.slice(i).map(l), r)
        ) {
            let c = null;
            ...
            (c === !1 && _a(t, s, l, i),
                $i(t, t.mapping.slice(i).map(l, 1), r, void 0, c === null));
            ...
            return (
                t.step(
                    new se(
                        ...
                        u + 1,
                        f - 1,
                        new E(v.from(r.create(a, null, s.marks)), 0, 0),
                        1,
                        !0,
                    ),
                ),
...
function Hp(t, e, n = 1, r) {
    let o = t.doc.resolve(e),
        i = v.empty,
        s = v.empty;
    for (let l = o.depth, a = o.depth - n, c = n - 1; l > a; l--, c--) {
        i = v.from(o.node(l).copy(i));
        let d = r && r[c];
        s = v.from(d ? d.type.create(d.attrs, s) : o.node(l).copy(s));
    }
    t.step(new ye(e, e, new E(i.append(s), n, n), !0));
}
function Re(t, e) {
    let n = t.resolve(e),
        r = n.index();
    return Wa(n.nodeBefore, n.nodeAfter) && n.parent.canReplace(r, r + 1);
}
function $p(t, e) {
...
function Wt(t, e, n = -1) {
    ...
    for (let o = r.depth; ; o--) {
        ...
        if (
            ...
            i && !i.isTextblock && Wa(i, s) && r.node(o).canReplace(l, l + 1))
        )
            return e;
        if (o == 0) break;
...
function Fp(t, e, n) {
    ...
    s.inlineContent &&
        $i(t, e + n - 1, s, i.node().contentMatchAt(i.index()), r == null);
    let a = t.mapping.slice(l),
        c = a.map(e - n);
    if ((t.step(new ye(c, a.map(e + n, -1), E.empty, !0)), r === !0)) {
        let d = t.doc.resolve(c);
        Va(t, d.node(), d.before(), t.steps.length);
    }
    return t;
}
function Vp(t, e, n) {
...
function qn(t, e, n = e, r = E.empty) {
    if (e == n && !r.size) return null;
    let o = t.resolve(e),
        i = t.resolve(n);
    return ja(o, i, r) ? new ye(e, n, r) : new zi(o, i, r).fit();
}
function ja(t, e, n) {
    return (
        !n.openStart &&
...
var zi = class {
    constructor(e, n, r) {
        ...
        for (let o = e.depth; o > 0; o--)
            this.placed = v.from(e.node(o).copy(this.placed));
    }
    get depth() {
    ...
    fit() {
        ...
        let a = new E(i, s, l);
        return e > -1
            ? new se(r.pos, e, this.$to.pos, this.$to.end(), a, n)
            : a.size || r.pos != this.$to.pos
              ? new ye(r.pos, o.pos, a)
              : null;
    }
    findFittable() {
        ...
        for (let n = 1; n <= 2; n++)
            for (let r = n == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
                let o,
                    i = null;
                r
                    ? ((i = Pi(this.unplaced.content, r - 1).firstChild),
                      (o = i.content))
    ...
    dropNode() {
        ...
        if (o.childCount <= 1 && n > 0) {
            ...
            this.unplaced = new E(Vn(e, n - 1, 1), n - 1, i ? n - 1 : r);
        } else this.unplaced = new E(Vn(e, n, 1), n, r);
    }
    placeNodes({
        sliceDepth: e,
        frontierDepth: n,
        ...
        let s = this.unplaced,
            ...
            c = 0,
            d = [],
            { match: u, type: f } = this.frontier[n];
        if (o) {
        ...
        (p || (h = -1),
            (this.placed = _n(this.placed, n, v.from(d))),
        ...
        this.unplaced = p
            ...
            : new E(Vn(s.content, e, c), s.openStart, s.openEnd);
    }
    mustMoveInline() {
        ...
        if (
            !e.type.isTextblock ||
            !Li(this.$to, this.$to.depth, e.type, e.match, !1) ||
    ...
    close(e) {
        ...
        (n.fit.childCount && (this.placed = _n(this.placed, n.depth, n.fit)),
            (e = n.move));
    ...
    openFrontierNode(e, n = null, r) {
        ...
        ((o.match = o.match.matchType(e)),
            (this.placed = _n(this.placed, this.depth, v.from(e.create(n, r)))),
            this.frontier.push({ type: e, match: e.contentMatch }));
    }
    closeFrontierNode() {
        let n = this.frontier.pop().match.fillBefore(v.empty, !0);
        n.childCount &&
            (this.placed = _n(this.placed, this.frontier.length, n));
    }
};
function Vn(t, e, n) {
    return e == 0
        ...
        : t.replaceChild(
              0,
              t.firstChild.copy(Vn(t.firstChild.content, e - 1, n)),
          );
}
function _n(t, e, n) {
    return e == 0
        ...
        : t.replaceChild(
              t.childCount - 1,
              t.lastChild.copy(_n(t.lastChild.content, e - 1, n)),
          );
}
function Pi(t, e) {
...
function Ua(t, e, n) {
    ...
    return (
        e > 1 &&
            (r = r.replaceChild(
                0,
                Ua(r.firstChild, e - 1, r.childCount == 1 ? n - 1 : 0),
            )),
        e > 0 &&
...
function Li(t, e, n, r, o) {
    ...
    return l && !_p(n, i.content, s) ? l : null;
}
function _p(t, e, n) {
...
function jp(t, e, n, r) {
    ...
    let o = t.doc.resolve(e),
        i = t.doc.resolve(n);
    if (ja(o, i, r)) return t.step(new ye(e, n, r));
    let s = qa(o, i);
...
function Ka(t, e, n, r, o) {
    ...
    if (e > r) {
        ...
        t = s.append(i.matchFragment(s).fillBefore(v.empty, !0));
    }
    return t;
}
function Up(t, e, n, r) {
    if (!r.isInline && e == n && t.doc.resolve(e).parent.content.size) {
        let o = Vp(t.doc, e, r.type);
        o != null && (e = n = o);
    }
    t.replaceRange(e, n, new E(v.from(r), 0, 0));
}
function Kp(t, e, n) {
...
var Lr = class t extends ce {
    constructor(e, n, r) {
        (super(), (this.pos = e), (this.attr = n), (this.value = r));
    }
    apply(e) {
        let n = e.nodeAt(this.pos);
        if (!n) return ue.fail("No node at attribute step's position");
        let r = Object.create(null);
...
var Tt = class {
    ...
    step(e) {
        ...
        if (n.failed) throw new pn(n.failed);
        return this;
    }
    maybeStep(e) {
    ...
    replace(e, n = e, r = E.empty) {
        let o = qn(this.doc, e, n, r);
        return (o && this.step(o), this);
    }
    replaceWith(e, n, r) {
        return this.replace(e, n, new E(v.from(r), 0, 0));
    }
    delete(e, n) {
    ...
    replaceRangeWith(e, n, r) {
        return (Up(this, e, n, r), this);
    }
    deleteRange(e, n) {
        return (Kp(this, e, n), this);
    }
    lift(e, n) {
        return (Rp(this, e, n), this);
    }
    join(e, n = 1) {
        return (Fp(this, e, n), this);
    }
    wrap(e, n) {
        return (Pp(this, e, n), this);
    }
    setBlockType(e, n = e, r, o = null) {
        return (Lp(this, e, n, r, o), this);
    }
    setNodeMarkup(e, n, r = null, o) {
        return (zp(this, e, n, r, o), this);
    }
    setNodeAttribute(e, n, r) {
        return (this.step(new Lr(e, n, r)), this);
    }
    setDocAttribute(e, n) {
        return (this.step(new Br(e, n)), this);
    }
    addNodeMark(e, n) {
    ...
    removeNodeMark(e, n) {
        ...
        if (n instanceof J) n.isInSet(r.marks) && this.step(new hn(e, n));
        else {
            let o = r.marks,
                i,
                s = [];
            for (; (i = n.isInSet(o)); )
                (s.push(new hn(e, i)), (o = i.removeFromSet(o)));
            for (let l = s.length - 1; l >= 0; l--) this.step(s[l]);
        }
        return this;
    }
    split(e, n = 1, r) {
        return (Hp(this, e, n, r), this);
    }
    addMark(e, n, r) {
        return (Ep(this, e, n, r), this);
    }
    removeMark(e, n, r) {
        return (Np(this, e, n, r), this);
    }
    clearIncompatible(e, n, r) {
        return ($i(this, e, n, r), this);
    }
};
var Fi = Object.create(null),
    I = class {
        constructor(e, n, r) {
            ((this.$anchor = e),
                (this.$head = n),
                (this.ranges = r || [new yn(e.min(n), e.max(n))]));
        }
        get anchor() {
            ...
            for (let i = 0; i < o.length; i++) {
                ...
                i
                    ...
                    : (e.replaceRangeWith(c, d, n),
                      Xa(e, r, n.isInline ? -1 : 1));
            }
        }
        static findFrom(e, n, r = !1) {
            let o = e.parent.inlineContent
                ? new D(e)
                : gn(e.node(0), e.parent, e.pos, e.index(), n, r);
            if (o) return o;
        ...
        static near(e, n = 1) {
            return (
                this.findFrom(e, n) || this.findFrom(e, -n) || new ke(e.node(0))
            );
        }
        static atStart(e) {
            return gn(e, e, 0, 0, 1) || new ke(e);
        }
        static atEnd(e) {
            return gn(e, e, e.content.size, e.childCount, -1) || new ke(e);
        }
        static fromJSON(e, n) {
            if (!n || !n.type)
        ...
        static jsonID(e, n) {
            ...
            return ((Fi[e] = n), (n.prototype.jsonID = e), n);
        }
        getBookmark() {
...
var D = class t extends I {
    ...
    getBookmark() {
        return new $r(this.anchor, this.head);
    }
    toJSON() {
    ...
    static between(e, n, r) {
        ...
        if (((!r || o) && (r = o >= 0 ? 1 : -1), !n.parent.inlineContent)) {
            let i = I.findFrom(n, r, !0) || I.findFrom(n, -r, !0);
            if (i) n = i.$head;
...
function gn(t, e, n, r, o, i = !1) {
    ...
    for (
        ...
        if (l.isAtom) {
            ...
            let a = gn(t, l, n + o, o < 0 ? l.childCount : 0, o, i);
            if (a) return a;
        }
        n += l.nodeSize * o;
    }
...
function Xa(t, e, n) {
    ...
    if (r < e) return;
    let o = t.steps[r];
    if (!(o instanceof ye || o instanceof se)) return;
    ...
    Wi = class extends Tt {
        ...
        setSelection(e) {
            ...
            return (
                (this.curSelection = e),
                (this.curSelectionFor = this.steps.length),
                (this.updated = (this.updated | Ya) & ~Hr),
                ...
                n &&
                    (e = e.mark(
                        this.storedMarks ||
                            (r.empty
                                ? r.$from.marks()
                                : r.$from.marksAcross(r.$to) || J.none),
                    )),
...
var jt = class {
        constructor(e, n, r) {
            ((this.name = e),
                (this.init = Za(n.init, r)),
                (this.apply = Za(n.apply, r)));
        }
    },
    Jp = [
        new jt("doc", {
    ...
    Fr = class t {
        ...
        static create(e) {
            let n = new Jn(e.doc ? e.doc.type.schema : e.schema, e.plugins),
                r = new t(n);
        ...
        reconfigure(e) {
            let n = new Jn(this.schema, e.plugins),
                r = n.fields,
                o = new t(n);
        ...
        static fromJSON(e, n, r) {
            ...
            let o = new Jn(e.schema, e.plugins),
                i = new t(o);
            return (
                o.fields.forEach((s) => {
                    if (s.name == "doc") i.doc = ie.fromJSON(e.schema, n.doc);
...
var P = class {
        constructor(e) {
            ((this.spec = e),
                (this.props = {}),
                e.props && ec(e.props, this, this.props),
                (this.key = e.key ? e.key.key : tc("plugin")));
        }
        getState(e) {
            return e[this.key];
        }
...
function tc(t) {
    return t in Vi ? t + "$" + ++Vi[t] : ((Vi[t] = 0), t + "$");
}
var H = class {
    constructor(e = "key") {
        this.key = tc(e);
...
var Ui = (t, e, n) => {
        ...
        let i = o.nodeBefore;
        if (fc(t, o, e, -1)) return !0;
        if (r.parent.content.size == 0 && (bn(i, "end") || L.isSelectable(i)))
            for (let s = r.depth; ; s--) {
                let l = qn(t.doc, r.before(s), r.after(s), E.empty);
...
function sc(t, e, n) {
    ...
    let c = qn(t.doc, i, a, E.empty);
    if (!c || c.from != i || (c instanceof ye && c.slice.size >= a - i))
        return !1;
    if (n) {
        let d = t.tr.step(c);
        (d.setSelection(D.create(d.doc, i)), n(d.scrollIntoView()));
    }
    return !0;
}
function bn(t, e, n = !1) {
...
var Ji = (t, e, n) => {
        ...
        if (
            ...
            (bn(i, "start") || L.isSelectable(i))
        ) {
            let s = qn(t.doc, r.before(), r.after(), E.empty);
...
var ac = (t, e) => {
        let n = t.selection,
            ...
            o;
        if (r) {
            if (n.node.isTextblock || !Re(t.doc, n.from)) return !1;
            o = n.from;
        } else if (((o = Wt(t.doc, n.from, -1)), o == null)) return !1;
        if (e) {
            let i = t.tr.join(o);
            (r &&
                i.setSelection(
    ...
    cc = (t, e) => {
        let n = t.selection,
            r;
        if (n instanceof L) {
            if (n.node.isTextblock || !Re(t.doc, n.to)) return !1;
            r = n.to;
        } else if (((r = Wt(t.doc, n.to, 1)), r == null)) return !1;
...
var Zi = (t, e) => {
    ...
    es = (t, e) => {
        let n = t.selection,
            { $from: r, $to: o } = n;
        if (n instanceof ke || r.parent.inlineContent || o.parent.inlineContent)
            return !1;
        let i = Qi(o.parent.contentMatchAt(o.indexAfter()));
...
function Gp(t) {
    return (e, n) => {
        ...
        if (e.selection instanceof L && e.selection.node.isBlock)
            return !r.parentOffset || !Ee(e.doc, r.pos)
                ? !1
        ...
        let d = e.tr;
        (e.selection instanceof D || e.selection instanceof ke) &&
            d.deleteSelection();
        let u = d.mapping.map(r.pos),
            f = Ee(d.doc, u, i.length, i);
        if (
            (f ||
                ((i[0] = l ? { type: l } : null),
                (f = Ee(d.doc, u, i.length, i))),
...
var uc = (t, e) => {
    ...
    Yp = (t, e) => (e && e(t.tr.setSelection(new ke(t.doc))), !0);
function Qp(t, e, n) {
    let r = e.nodeBefore,
        o = e.nodeAfter,
        i = e.index();
    ...
    return function (e, n) {
        ...
        return o.node(i).isTextblock
            ? (n &&
                  n(
                      e.tr.setSelection(
                          D.create(e.doc, t < 0 ? o.start(i) : o.end(i)),
                      ),
                  ),
              !0)
            : !1;
...
var ji = ss(Vr, Ui, Ki),
    ...
    Zp = {
        "Ctrl-h": At.Backspace,
        "Alt-Backspace": At["Mod-Backspace"],
        "Ctrl-d": At.Delete,
        "Ctrl-Alt-Backspace": At["Mod-Delete"],
        "Alt-Delete": At["Mod-Delete"],
        "Alt-d": At["Mod-Delete"],
        "Ctrl-a": ns,
        "Ctrl-e": rs,
    };
for (let t in At) Zp[t] = At[t];
var ck =
    typeof navigator < "u"
...
function mc(t, e = null) {
    return function (n, r) {
        ...
        if (!s) return !1;
        let l = r ? n.tr : null;
        return em(l, s, t, e) ? (r && r(l.scrollIntoView()), !0) : !1;
    };
}
function em(t, e, n, r = null) {
    ...
    if (
        ...
        ((i = new Vt(a, a, e.depth)),
            e.endIndex < e.parent.childCount &&
                (e = new Vt(e.$from, s.resolve(e.$to.end(e.depth)), e.depth)),
            (o = !0));
    }
    let l = mn(i, n, r, e);
    return l ? (t && tm(t, e, l, o, n), !0) : !1;
}
function tm(t, e, n, r, o) {
    ...
    for (let d = e.startIndex, u = e.endIndex, f = !0; d < u; d++, f = !1)
        (!f && Ee(t.doc, a, l) && (t.split(a, l), (a += 2 * l)),
    ...
    i < s &&
        (o.step(
            new se(
                ...
                i,
                s,
                new E(v.from(n.create(null, r.parent.copy())), 1, 0),
                1,
                !0,
            ),
        ),
        (r = new Vt(o.doc.resolve(r.$from.pos), o.doc.resolve(s), r.depth)));
    let l = ft(r);
    if (l == null) return !1;
    o.lift(r, l);
...
function rm(t, e, n) {
    ...
    if (
        !c.canReplace(
            d + (l ? 0 : 1),
            d + 1,
            s.content.append(a ? v.empty : v.from(o)),
        )
    )
        return !1;
    let u = i.pos,
    ...
    return (
        r.step(
            new se(
                ...
                f - 1,
                new E(
                    (l ? v.empty : v.from(o.copy(v.empty))).append(
                        a ? v.empty : v.from(o.copy(v.empty)),
                    ),
                    l ? 0 : 1,
                    a ? 0 : 1,
                ),
    ...
    return function (e, n) {
        ...
        if (n) {
            let c = a.lastChild && a.lastChild.type == l.type,
                d = v.from(c ? t.create() : null),
                u = new E(
                    v.from(t.create(null, v.from(l.type.create(null, d)))),
                    c ? 3 : 1,
                    0,
                ),
                f = i.start,
            ...
            n(
                e.tr
                    .step(new se(f - (c ? 3 : 1), h, f, h, u, 1, !0))
                    .scrollIntoView(),
            );
        }
        return !0;
...
var fe = function (t) {
    ...
    Yt = function (t, e, n, r) {
        return n && (bc(t, e, n, r, -1) || bc(t, e, n, r, 1));
    },
...
function sm(t, e) {
    for (;;) {
        ...
        } else if (t.parentNode && !nr(t)) ((e = fe(t)), (t = t.parentNode));
        else return null;
    }
}
function lm(t, e) {
...
var Qr = function (t) {
    return (
        t.focusNode &&
        Yt(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset)
    );
};
function Ut(t, e) {
    ...
    if (t.caretPositionFromPoint)
        try {
            ...
            if (r)
                return {
                    node: r.offsetNode,
                    offset: Math.min(Ie(r.offsetNode), r.offset),
                };
        } catch {}
    if (t.caretRangeFromPoint) {
        ...
        if (r)
            return {
                ...
                offset: Math.min(Ie(r.startContainer), r.startOffset),
            };
    }
}
var Ye = typeof navigator < "u" ? navigator : null,
    wc = typeof document < "u" ? document : null,
    It = (Ye && Ye.userAgent) || "",
    hs = /Edge\/(\d+)/.exec(It),
    Yc = /MSIE \d/.exec(It),
    ps = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(It),
    ve = !!(Yc || ps || hs),
    Rt = Yc ? document.documentMode : ps ? +ps[1] : hs ? +hs[1] : 0,
    Pe = !ve && /gecko\/(\d+)/i.test(It);
Pe && +(/Firefox\/(\d+)/.exec(It) || [0, 0])[1];
var ms = !ve && /Chrome\/(\d+)/.exec(It),
    de = !!ms,
    Qc = ms ? +ms[1] : 0,
    we = !ve && !!Ye && /Apple Computer/.test(Ye.vendor),
    vn = we && (/Mobile\/\w+/.test(It) || (!!Ye && Ye.maxTouchPoints > 2)),
    De = vn || (Ye ? /Mac/.test(Ye.platform) : !1),
    Zc = Ye ? /Win/.test(Ye.platform) : !1,
    mt = /Android \d/.test(It),
    rr = !!wc && "webkitFontSmoothing" in wc.documentElement.style,
    um = rr
    ...
    for (let s = n || t.dom; s; ) {
        ...
        if (
            (e.top < c.top + ht(r, "top")
                ? (u = -(c.top - e.top + ht(o, "top")))
                : e.bottom > c.bottom - ht(r, "bottom") &&
                  (u =
                      e.bottom - e.top > c.bottom - c.top
                          ? e.top + ht(o, "top") - c.top
                          : e.bottom - c.bottom + ht(o, "bottom")),
            e.left < c.left + ht(r, "left")
                ? (d = -(c.left - e.left + ht(o, "left")))
                : e.right > c.right - ht(r, "right") &&
                  (d = e.right - c.right + ht(o, "right")),
            d || u)
        )
        ...
        s = f == "absolute" ? s.offsetParent : Cn(s);
    }
}
function pm(t) {
    ...
    return { refDOM: r, refTop: o, stack: ed(t.dom) };
}
function ed(t) {
    let e = [],
        n = t.ownerDocument;
...
function mm({ refDOM: t, refTop: e, stack: n }) {
...
function km(t, e) {
    ...
    if (!s || !t.dom.contains(s.nodeType != 1 ? s.parentNode : s)) {
        ...
        if (!Os(e, c) || ((s = rd(t.dom, e, c)), !s)) return null;
    }
    if (we) for (let c = s; r && c; c = Cn(c)) c.draggable && (r = void 0);
    if (((s = bm(s, e)), r)) {
        if (
            Pe &&
            r.nodeType == 1 &&
...
function Et(t, e) {
    ...
    return Array.prototype.find.call(n, kc) || t.getBoundingClientRect();
}
var Sm = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/;
function od(t, e, n) {
    let {
    ...
    if (r.nodeType == 3)
        if (
            s &&
            (Sm.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))
        ) {
            let a = Et(pt(r, o, o), n);
            if (
                Pe &&
                ...
                let c = Et(pt(r, o - 1, o - 1), -1);
                if (c.top == a.top) {
                    let d = Et(pt(r, o, o + 1), -1);
                    if (d.top != a.top) return Gn(d, d.left < c.left);
                }
            }
            return a;
        } else {
                ...
                n < 0 && !o
                    ...
                    : n >= 0 && o == r.nodeValue.length
                      ...
                      : n < 0
                        ? a--
                        : c++,
                Gn(Et(pt(r, a, c), d), d < 0)
            );
        }
    if (!t.state.doc.resolve(e - (i || 0)).parent.inlineContent) {
        if (i == null && o && (n < 0 || o == Ie(r))) {
            let a = r.childNodes[o - 1];
            if (a.nodeType == 1) return ls(a.getBoundingClientRect(), !1);
        }
        if (i == null && o < Ie(r)) {
            let a = r.childNodes[o];
            if (a.nodeType == 1) return ls(a.getBoundingClientRect(), !0);
        }
        ...
        let c = a
            ? a.nodeType == 3
                ...
                : a.nodeType == 1
                  ...
                  : null
            : null;
        if (c) return Gn(Et(c, -1), !0);
    }
    return Gn(Et(r.nodeType == 3 ? pt(r) : r, -n), n >= 0);
}
function Gn(t, e) {
...
function Mm(t, e, n) {
    ...
    let o = r.parentOffset,
        ...
        l = t.domSelection();
    return l
        ? !vm.test(r.parent.textContent) || !l.modify
            ? n == "left" || n == "backward"
                ? i
                : s
            : id(t, e, () => {
...
function Tm(t, e, n) {
    return Sc == e && Cc == n
        ...
        : ((Sc = e),
          (Cc = n),
          (vc = n == "up" || n == "down" ? Cm(t, e, n) : Mm(t, e, n)));
}
var Le = 0,
    Mc = 1,
    Kt = 2,
    ...
    Qt = class {
        ...
        localPosFromDOM(e, n, r) {
            ...
            let o;
            if (e == this.dom && this.contentDOM) o = n > fe(this.contentDOM);
            else if (
                this.contentDOM &&
        ...
        domFromPos(e, n) {
            ...
            if (n <= 0) {
                ...
                return i && n && s && !i.border && !i.domAtom
                    ...
                    : { node: this.contentDOM, offset: i ? fe(i.dom) + 1 : 0 };
            } else {
                let i,
                    s = !0;
                for (
...
`
            ...
            if (
                !(o || (u && we)) &&
                Yt(l.node, l.offset, d.anchorNode, d.anchorOffset) &&
                Yt(a.node, a.offset, d.focusNode, d.focusOffset)
            )
                return;
            let f = !1;
            if ((c.extend || e == n) && !(u && Pe)) {
    ...
    Mn = class t extends Qt {
        ...
        markDirty(e, n) {
            if ((super.markDirty(e, n), this.dirty != Le)) {
                let r = this.parent;
        ...
        slice(e, n, r) {
            let o = t.create(this.parent, this.mark, !0, r),
                i = this.children,
                s = this.size;
            (n < s && (i = xs(i, n, s, r)), e > 0 && (i = xs(i, 0, e, r)));
    ...
    Dt = class t extends Qt {
        ...
        static create(e, n, r, o, i, s) {
            ...
            if (n.isText) {
                ...
                d ||
                    ({ dom: d, contentDOM: u } = ct.renderSpec(
                        document,
                        n.type.spec.toDOM(n),
                        null,
                        n.attrs,
            ...
            return (
                (d = ad(d, r, n)),
                c
                    ? (a = new ys(e, n, r, o, d, u || null, f, c, i, s + 1))
                    : n.isText
                      ? new Wr(e, n, r, o, d, f, i)
        ...
        updateChildren(e, n) {
            ...
            (Om(
                ...
                a.destroyRest(),
                (a.changed || this.dirty == Kt) &&
                    (s && this.protectLocalComposition(e, s),
                    sd(this.contentDOM, this.children, e),
                    vn && Rm(this.dom)));
        }
        localCompositionInfo(e, n) {
            ...
            if (this.node.inlineContent) {
                let s = i.nodeValue,
                    l = Dm(this.node.content, s, r - n, o - n);
        ...
        protectLocalComposition(e, { node: n, pos: r, text: o }) {
            ...
            let s = new gs(this, i, n, o);
            (e.input.compositionNodes.push(s),
                (this.children = xs(this.children, r, r + o.length, e, s)));
        }
        update(e, n, r, o) {
        ...
        updateOuterDeco(e) {
            if (Ur(e, this.outerDeco)) return;
            let n = this.nodeDOM.nodeType != 1,
                r = this.dom;
            ((this.dom = ld(
                this.dom,
                this.nodeDOM,
                bs(this.outerDeco, this.node, n),
                bs(e, this.node, n),
            )),
                this.dom != r &&
...
function Tc(t, e, n, r, o) {
    ad(r, e, t);
    let i = new Dt(void 0, t, e, n, r, r, r, o, 0);
    return (i.contentDOM && i.updateChildren(o, 0), i);
}
var Wr = class t extends Dt {
...
Xn.prototype = Object.create(null);
var qt = [new Xn()];
function bs(t, e, n) {
    ...
    for (let i = 0; i < t.length; i++) {
        ...
        if (s) {
            s.nodeName && o.push((r = new Xn(s.nodeName)));
            for (let l in s) {
                let a = s[l];
                a != null &&
                    (n &&
                        o.length == 1 &&
                        o.push((r = new Xn(e.isInline ? "span" : "div"))),
                    l == "class"
...
function ad(t, e, n) {
    return ld(t, t, qt, bs(e, n, t.nodeType != 1));
}
function Ur(t, e) {
    if (t.length != e.length) return !1;
...
var ws = class {
    constructor(e, n, r) {
        ((this.lock = n),
            ...
            (this.changed = !1),
            (this.top = e),
            (this.preMatch = Em(e.node.content, e)));
    }
    destroyBetween(e, n) {
        if (e != n) {
    ...
    updateNodeAt(e, n, r, o, i) {
        ...
        return (
            s.dirty == Qe && s.dom == s.contentDOM && (s.dirty = Kt),
            s.update(e, n, r, i)
    ...
    recreateWrapper(e, n, r, o, i, s) {
        if (
            ...
            return null;
        let l = Dt.create(this.top, n, r, o, i, s);
        if (l.contentDOM) {
    ...
    addNode(e, n, r, o, i) {
        let s = Dt.create(this.top, e, n, r, o, i);
    ...
    e: for (; o > 0; ) {
        ...
        for (;;)
            if (r) {
                ...
                if (c instanceof Mn) ((n = c), (r = c.children.length));
                else {
                    ((l = c), r--);
                    break;
                }
...
function Rs(t, e = null) {
    ...
    if (Qr(n)) {
        ...
        if (
            ...
            L.isSelectable(u) &&
            o.parent &&
            !(u.isInline && am(n.focusNode, n.focusOffset, o.dom))
        ) {
            let f = o.posBefore;
    ...
    if ((dd(t, n), !!cd(t))) {
        if (!e && t.input.mouseDown && t.input.mouseDown.allowDefault && de) {
            ...
            if (
                r.anchorNode &&
                o.anchorNode &&
                Yt(r.anchorNode, r.anchorOffset, o.anchorNode, o.anchorOffset)
            ) {
        ...
        if ((t.domObserver.disconnectSelection(), t.cursorWrapper)) Pm(t);
        else {
            ...
            (Ec &&
                !(n instanceof D) &&
                (n.$from.parent.inlineContent || (i = Nc(t, n.from)),
                !n.empty && !n.$from.parent.inlineContent && (s = Nc(t, n.to))),
                ...
                n.visible
                    ...
                    : (t.dom.classList.add("ProseMirror-hideselection"),
                      "onselectionchange" in document && Im(t)));
        }
...
function Nc(t, e) {
    ...
    if (we && o && o.contentEditable == "false") return as(o);
    if (
    ...
    e.addEventListener(
        ...
        (t.input.hideSelectionGuard = () => {
            (n.anchorNode != r || n.anchorOffset != o) &&
                ...
                setTimeout(() => {
                    (!cd(t) || t.state.selection.visible) &&
                        t.dom.classList.remove("ProseMirror-hideselection");
                }, 20));
        }),
    );
...
function Pm(t) {
    ...
    let n = t.cursorWrapper.dom,
        r = n.nodeName == "IMG";
    (r ? e.collapse(n.parentNode, fe(n) + 1) : e.collapse(n, 0),
        !r &&
...
function dd(t, e) {
    if (e instanceof L) {
        ...
        n != t.lastSelectedViewDesc &&
            (Rc(t), n && n.selectNode(), (t.lastSelectedViewDesc = n));
    } else Rc(t);
}
function Rc(t) {
...
function Dc(t) {
    return t.editable && !t.hasFocus() ? !1 : ud(t);
}
function ud(t) {
...
function Lm(t) {
    ...
    return Yt(e.node, e.offset, n.anchorNode, n.anchorOffset);
}
function ks(t, e) {
...
function Ic(t, e, n) {
    ...
    if (r instanceof D)
        if (n.indexOf("s") > -1) {
            ...
            return Nt(t, new D(r.$anchor, s));
        } else if (r.empty) {
            if (t.endOfTextblock(e > 0 ? "forward" : "backward")) {
                let o = ks(t.state, e);
                return o && o instanceof L ? Nt(t, o) : !1;
            } else if (!(De && n.indexOf("m") > -1)) {
                let o = r.$head,
                    i = o.textOffset
                        ? null
                        : e < 0
        ...
        if (r instanceof L && r.node.isInline)
            return Nt(t, new D(e > 0 ? r.$to : r.$from));
        {
            let o = ks(t.state, e);
            return o ? Nt(t, o) : !1;
        }
    ...
    for (
        ...
        if (r > 0) {
            ...
            if (fd(n)) break;
            {
                ...
                for (; l && Yn(l, -1); )
                    ((o = n.parentNode), (i = fe(l)), (l = l.previousSibling));
                if (l) ((n = l), (r = Kr(n)));
                else {
    ...
    for (;;)
        if (r < o) {
            ...
            if (fd(n)) break;
            {
                let l = n.nextSibling;
                for (; l && Yn(l, 1); )
                    ((i = l.parentNode), (s = fe(l) + 1), (l = l.nextSibling));
                if (l) ((n = l), (r = 0), (o = Kr(n)));
                else {
                    if (((n = n.parentNode), n == t.dom)) break;
                    r = o = 0;
...
function Hm(t, e) {
    for (; t && e == t.childNodes.length && !nr(t); )
        ((e = fe(t) + 1), (t = t.parentNode));
...
function $m(t, e) {
    for (; t && !e && !nr(t); ) ((e = fe(t)), (t = t.parentNode));
    for (; t && e; ) {
...
function Pc(t, e) {
    ...
    if (!(de || Zc) && n.parent.inlineContent) {
...
function Lc(t, e, n) {
    ...
    if (!o.parent.inlineContent || t.endOfTextblock(e < 0 ? "up" : "down")) {
        let s = ks(t.state, e);
        if (s && s instanceof L) return Nt(t, s);
    }
    if (!o.parent.inlineContent) {
        let s = e < 0 ? o : i,
            l = r instanceof ke ? I.near(s, e) : I.findFrom(s, e);
        return l ? Nt(t, l) : !1;
    }
    return !1;
}
function Bc(t, e) {
    if (!(t.state.selection instanceof D)) return !0;
...
function _m(t, e) {
    let n = e.keyCode,
        r = Vm(e);
    if (n == 8 || (De && n == 72 && r == "c")) return Bc(t, -1) || xn(t, -1);
    if ((n == 46 && !e.shiftKey) || (De && n == 68 && r == "c"))
        return Bc(t, 1) || xn(t, 1);
    if (n == 13 || n == 27) return !0;
    if (n == 37 || (De && n == 66 && r == "c")) {
        let o =
            n == 37 ? (Pc(t, t.state.selection.from) == "ltr" ? -1 : 1) : -1;
        return Ic(t, o, r) || xn(t, o);
    } else if (n == 39 || (De && n == 70 && r == "c")) {
        let o = n == 39 ? (Pc(t, t.state.selection.from) == "ltr" ? 1 : -1) : 1;
        return Ic(t, o, r) || xn(t, o);
    } else {
        if (n == 38 || (De && n == 80 && r == "c"))
            return Lc(t, -1, r) || xn(t, -1);
        if (n == 40 || (De && n == 78 && r == "c"))
            return Fm(t) || Lc(t, 1, r) || xn(t, 1);
        if (r == (De ? "m" : "c") && (n == 66 || n == 73 || n == 89 || n == 90))
            return !0;
    }
    return !1;
}
function Is(t, e) {
    ...
    let c = a.firstChild,
        d,
        u = 0;
    for (; c && c.nodeType == 1 && (d = yd[c.nodeName.toLowerCase()]); ) {
...
`,
    ...
    if (
        ...
        l = Jm(Hc(l, +d[1], +d[2]), d[4]);
    else if (
        ((l = E.maxOpen(jm(l.content, o), !0)), l.openStart || l.openEnd)
    ) {
        let u = 0,
            f = 0;
        for (
    ...
    for (let n = e.depth; n >= 0; n--) {
        ...
        if (
            (t.forEach((l) => {
                ...
                if (
                    (c =
                        s.length && i.length && md(a, i, l, s[s.length - 1], 0))
                )
                    s[s.length - 1] = c;
                else {
                    s.length &&
                        (s[s.length - 1] = gd(s[s.length - 1], i.length));
                    let d = pd(l, a);
...
function md(t, e, n, r, o) {
    if (o < t.length && o < e.length && t[o] == e[o]) {
        let i = md(t, e, n, r.lastChild, o + 1);
        ...
        if (
            ...
            return r.copy(r.content.append(v.from(pd(n, t, o + 1))));
    }
}
function gd(t, e) {
    if (e == 0) return t;
    let n = t.content.replaceChild(t.childCount - 1, gd(t.lastChild, e - 1)),
...
function Hc(t, e, n) {
    return (
        e < t.openStart &&
            (t = new E(
                Cs(t.content, -1, e, t.openStart, 0, t.openEnd),
                e,
                t.openEnd,
            )),
        n < t.openEnd &&
            (t = new E(Cs(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)),
        t
    );
}
var yd = {
...
function Km(t) {
    ...
    let n = bd().createElement("div"),
        r = /<([a-z][^>\s]+)/i.exec(t),
        o;
    if (
        ((o = r && yd[r[1].toLowerCase()]) &&
            (t =
                o.map((i) => "<" + i + ">").join("") +
                t +
                o
...
function Xm(t) {
    for (let e in Se) {
        ...
        t.dom.addEventListener(
            ...
            Gm[e] ? { passive: !0 } : void 0,
        );
    }
    (we && t.dom.addEventListener("input", () => null), Ms(t));
}
function Ot(t, e) {
    ...
    t.someProp("handleDOMEvents", (e) => {
        for (let n in e)
            t.input.eventHandlers[n] ||
                t.dom.addEventListener(
                    n,
                    (t.input.eventHandlers[n] = (r) => Ps(t, r)),
                );
    });
}
function Ps(t, e) {
...
Ce.keydown = (t, e) => {
    ...
    if (
        ...
        if (
            ...
            vn && n.keyCode == 13 && !n.ctrlKey && !n.altKey && !n.metaKey)
        ) {
            let r = Date.now();
            ...
            t.someProp("handleKeyDown", (r) => r(t, n)) || _m(t, n)
                ? n.preventDefault()
                : Ot(t, "key");
};
Ce.keyup = (t, e) => {
...
function ng(t, e) {
    ...
    return o != null ? (Sn(t, L.create(t.state.doc, o), "pointer"), !0) : !1;
}
function rg(t, e, n, r, o) {
    return (
        Ls(t, "handleClickOn", e, n, r) ||
...
function og(t, e, n, r) {
    return (
        Ls(t, "handleDoubleClickOn", e, n, r) ||
        t.someProp("handleDoubleClick", (o) => o(t, e, r))
    );
}
function ig(t, e, n, r) {
    return (
        Ls(t, "handleTripleClickOn", e, n, r) ||
...
function sg(t, e, n) {
    ...
    if (e == -1)
        return r.inlineContent
            ? (Sn(t, D.create(r, 0, r.content.size), "pointer"), !0)
            : !1;
    let o = r.resolve(e);
    for (let i = o.depth + 1; i > 0; i--) {
        let s = i > o.depth ? o.nodeAfter : o.node(i),
            l = o.before(i);
        if (s.inlineContent)
            Sn(t, D.create(r, l + 1, l + 1 + s.content.size), "pointer");
        else if (L.isSelectable(s)) Sn(t, L.create(r, l), "pointer");
        else continue;
        return !0;
    }
}
...
Se.mousedown = (t, e) => {
    ...
    let s = t.posAtCoords(Zr(n));
    s &&
        (i == "singleClick"
            ? (t.input.mouseDown && t.input.mouseDown.done(),
              (t.input.mouseDown = new Ts(t, s, n, !!r)))
            : (i == "doubleClick" ? og : ig)(t, s.pos, s.inside, n)
              ? n.preventDefault()
              : Ot(t, "pointer"));
};
var Ts = class {
    constructor(e, n, r, o) {
        ...
        (this.view.root.removeEventListener("mouseup", this.up),
            ...
            this.mightDrag &&
                ...
                this.view.domObserver.start()),
            this.delayedSelectionSync && setTimeout(() => gt(this.view)),
    ...
    up(e) {
        ...
        (this.view.state.doc != this.startDoc &&
            (n = this.view.posAtCoords(Zr(e))),
            this.updateAllowDefault(e),
            this.allowDefault || !n
                ? Ot(this.view, "pointer")
                : rg(this.view, n.pos, n.inside, e, this.selectNode)
                  ? e.preventDefault()
                  : e.button == 0 &&
                      (this.flushed ||
                          (we &&
...
Se.touchstart = (t) => {
    ((t.input.lastTouch = Date.now()), Bs(t), Ot(t, "pointer"));
};
Se.touchmove = (t) => {
    ((t.input.lastTouch = Date.now()), Ot(t, "pointer"));
};
Se.contextmenu = (t) => Bs(t);
function xd(t, e) {
    return t.composing
        ? !0
...
function kd(t, e) {
    (clearTimeout(t.input.composingTimeout),
        e > -1 && (t.input.composingTimeout = setTimeout(() => qr(t), e)));
}
function Sd(t) {
    for (
        t.composing &&
        ((t.input.composing = !1), (t.input.compositionEndedAt = dg()));
...
function cg(t) {
    ...
    let n = sm(e.focusNode, e.focusOffset),
        r = lm(e.focusNode, e.focusOffset);
    if (n && r && n != r) {
        let o = r.pmViewDesc,
...
var Qn = (ve && Rt < 15) || (vn && um < 604);
Se.copy = Ce.cut = (t, e) => {
    let n = e,
        r = t.state.selection,
        o = n.type == "cut";
    if (r.empty) return;
    let i = Qn ? null : n.clipboardData,
        s = r.content(),
        { dom: l, text: a } = Is(t, s);
    (i
        ? (n.preventDefault(),
...
function hg(t, e) {
    ...
    setTimeout(() => {
        (t.focus(),
            ...
            n
                ? Zn(t, r.value, null, o, e)
                : Zn(t, r.textContent, r.innerHTML, o, e));
    }, 50);
}
function Zn(t, e, n, r, o) {
    let i = hd(t, e, n, r, t.state.selection.$from);
...
Ce.paste = (t, e) => {
    ...
    let r = Qn ? null : n.clipboardData,
        o = t.input.shiftKey && t.input.lastKeyCode != 45;
    r && Zn(t, Cd(r), r.getData("text/html"), o, n)
        ? n.preventDefault()
        : hg(t, n);
};
var Jr = class {
...
Se.dragstart = (t, e) => {
    ...
    let o = t.state.selection,
        i = o.empty ? null : t.posAtCoords(Zr(n)),
        s;
    if (
        !(i && i.pos >= o.from && i.pos <= (o instanceof L ? o.to - 1 : o.to))
    ) {
    ...
    let l = (s || t.state.selection).content(),
        { dom: a, text: c, slice: d } = Is(t, l);
    ((!n.dataTransfer.files.length || !de || Qc > 120) &&
        n.dataTransfer.clearData(),
        n.dataTransfer.setData(Qn ? "Text" : "text/html", a.innerHTML),
        (n.dataTransfer.effectAllowed = "copyMove"),
        Qn || n.dataTransfer.setData("text/plain", c),
        (t.dragging = new Jr(d, vd(t, n), s)));
};
Se.dragend = (t) => {
    let e = t.dragging;
    window.setTimeout(() => {
...
function mg(t, e, n) {
    ...
    i
        ...
        : (i = hd(
              t,
              Cd(e.dataTransfer),
              Qn ? null : e.dataTransfer.getData("text/html"),
              !1,
              o,
          ));
    let s = !!(n && vd(t, e));
    if (t.someProp("handleDrop", (h) => h(t, e, i || E.empty, s))) {
        e.preventDefault();
        return;
    }
    if (!i) return;
    e.preventDefault();
    let l = i ? zr(t.state.doc, o.pos, i) : o.pos;
    l == null && (l = o.pos);
    let a = t.state.tr;
    if (s) {
        let { node: h } = n;
    ...
    if (
        ...
        (a.mapping.maps[a.mapping.maps.length - 1].forEach(
            ...
            a.setSelection(Ds(t, f, a.doc.resolve(h))));
    }
...
Se.beforeinput = (t, e) => {
    if (de && mt && e.inputType == "deleteContentBackward") {
        ...
        setTimeout(() => {
            if (
                ...
                (t.dom.blur(),
                t.focus(),
                t.someProp("handleKeyDown", (i) => i(t, Ut(8, "Backspace"))))
            )
                return;
...
var Gr = class t {
            ...
            return (
                ...
                (e instanceof t &&
                    ((this.spec.key && this.spec.key == e.spec.key) ||
                        (this.toDOM == e.toDOM && er(this.spec, e.spec))))
            );
        }
        destroy(e) {
    ...
    te = class t {
        ...
        static widget(e, n, r) {
            return new t(e, e, new Gr(n, r));
        }
        static inline(e, n, r, o) {
            return new t(e, n, new Jt(r, o));
        }
        static node(e, n, r, o) {
            return new t(e, n, new As(r, o));
        }
        get spec() {
        ...
        get widget() {
            return this.type instanceof Gr;
        }
    },
    kn = [],
    Gt = {},
    Y = class t {
        constructor(e, n) {
            ((this.local = e.length ? e : kn),
                (this.children = n.length ? n : kn));
        }
        static create(e, n) {
            return n.length ? Yr(n, e, 0, Gt) : be;
        }
        find(e, n, r) {
            let o = [];
        ...
        map(e, n, r) {
            return this == be || e.maps.length == 0
                ? this
                : this.mapInner(e, n, 0, 0, r || Gt);
        }
        mapInner(e, n, r, o, i) {
            let s;
        ...
        addInner(e, n, r) {
            ...
            return new t(
                s.length ? this.local.concat(s).sort(Xt) : this.local,
                o || this.children,
            );
        }
        remove(e) {
...
var be = Y.empty,
    Xr = class t {
        ...
        map(e, n) {
            let r = this.members.map((o) => o.map(e, n, Gt));
            return t.from(r);
        }
        forChild(e, n) {
                ...
                default:
                    return new t(
                        e.every((n) => n instanceof Y)
                            ...
                            : e.reduce(
                                  (n, r) =>
                                      n.concat(r instanceof Y ? r : r.members),
                                  [],
                              ),
                    );
            }
...
function Yr(t, e, n, r) {
    ...
    e.forEach((l, a) => {
        ...
        if (c) {
            i = !0;
            let d = Yr(c, l, n + a + 1, r);
            d != be && o.push(a, a + l.nodeSize, d);
        }
    });
    let s = Md(i ? Ad(t) : t, -n).sort(Xt);
    for (let l = 0; l < s.length; l++)
        s[l].type.valid(e, s[l]) ||
            (r.onRemove && r.onRemove(s[l].spec), s.splice(l--, 1));
    return s.length || o.length ? new Y(s, o) : be;
}
function Xt(t, e) {
            ...
            for (let o = n + 1; o < e.length; o++) {
                ...
                if (i.from == r.from) {
                    i.to != r.to &&
                        ...
                        Fc(e, o + 1, i.copy(r.to, i.to)));
                    continue;
                } else {
                    i.from < r.to &&
                        (e == t && (e = t.slice()),
                        (e[n] = r.copy(r.from, i.from)),
                        Fc(e, o, r.copy(i.from, r.to)));
                    break;
                }
            }
    }
...
function ds(t) {
    ...
    return (
        ...
        t.cursorWrapper &&
            e.push(Y.create(t.state.doc, [t.cursorWrapper.deco])),
        Xr.from(e)
    );
}
var bg = {
    ...
    Ns = class {
        ...
        start() {
            (this.observer &&
                ...
                this.observer.observe(this.view.dom, bg)),
                this.onCharData &&
        ...
        onSelectionChange() {
            if (Dc(this.view)) {
                ...
                if (ve && Rt <= 11 && !this.view.state.selection.empty) {
        ...
        ignoreSelectionChange(e) {
            ...
            let n = new Set(),
                r;
            for (let i = e.focusNode; i; i = Cn(i)) n.add(i);
            for (let i = e.anchorNode; i; i = Cn(i))
                if (n.has(i)) {
                    r = i;
                    break;
                }
        ...
        flush() {
            ...
            c.eq(I.near(e.state.doc.resolve(0), 1))
                ? ((e.input.lastFocus = 0),
                  ...
                  e.scrollToSelection())
                : (i > -1 || o) &&
                  (i > -1 && (e.docView.markDirty(i, s), xg(e)),
        ...
        registerMutation(e, n) {
            ...
            if (e.type == "childList") {
                for (let d = 0; d < e.addedNodes.length; d++) {
                    ...
                    (n.push(u),
                        u.nodeType == 3 && (this.lastChangedTextNode = u));
                }
                if (
                    r.contentDOM &&
                    r.contentDOM != r.dom &&
                ...
                let o = e.previousSibling,
                    i = e.nextSibling;
                if (ve && Rt <= 11 && e.addedNodes.length)
                    for (let d = 0; d < e.addedNodes.length; d++) {
                        let { previousSibling: u, nextSibling: f } =
                            e.addedNodes[d];
                        ((!u ||
                            Array.prototype.indexOf.call(e.addedNodes, u) <
                                0) &&
                            (o = u),
                            (!f ||
                ...
                let s = o && o.parentNode == e.target ? fe(o) + 1 : 0,
...
function xg(t) {
    if (
        ...
        if (((t.requiresGeckoHackNode = Pe), _c)) return;
        (console.warn(
...
function Wc(t, e) {
    ...
    return (
        Yt(s.node, s.offset, o, i) && ([n, r, o, i] = [o, i, n, r]),
...
function Cg(t, e, n) {
    ...
    if (
        (d &&
            ...
            Qr(a) || c.push({ node: a.focusNode, offset: a.focusOffset })),
        de && t.input.lastKeyCode === 8)
    )
        for (let g = i; g > o; g--) {
    ...
    let u = t.state.doc,
        f = t.someProp("domParser") || Xe.fromSchema(t.state.schema),
        h = u.resolve(s),
        p = null,
        m = f.parse(r, {
            topNode: h.parent,
...
function Tg(t, e, n, r, o) {
    ...
    if (((t.input.compositionPendingChanges = 0), e < 0)) {
        ...
        if (O && !t.state.selection.eq(O)) {
            if (
                ...
                t.someProp("handleKeyDown", (A) => A(t, Ut(13, "Enter")))
            )
                return;
            let T = t.state.tr.setSelection(O);
            (k == "pointer"
                ? T.setMeta("pointer", !0)
                : k == "key" && T.scrollIntoView(),
    ...
    let p = Ng(u.content, c.doc.content, c.from, f, h);
    if (
        (p && t.input.domChangeCount++,
        ((vn && t.input.lastIOSEnter > Date.now() - 225) || mt) &&
            o.some((k) => k.nodeType == 1 && !Mg.test(k.nodeName)) &&
            (!p || p.endA >= p.endB) &&
            t.someProp("handleKeyDown", (k) => k(t, Ut(13, "Enter"))))
    ) {
        t.input.lastIOSEnter = 0;
        return;
    }
    if (!p)
        if (
            ...
            if (c.sel) {
                let k = jc(t, t.state.doc, c.sel);
                if (k && !k.eq(t.state.selection)) {
                    let O = t.state.tr.setSelection(k);
                    (i && O.setMeta("composition", i), t.dispatch(O));
                }
            }
            return;
        }
    (t.state.selection.from < t.state.selection.to &&
        p.start == p.endB &&
        t.state.selection instanceof D &&
    ...
    let m = c.doc.resolveNoCache(p.start - c.from),
        ...
        y = d.resolve(p.start),
        w = m.sameParent(g) && m.parent.inlineContent && y.end() >= p.endA;
    if (
        ((vn &&
            t.input.lastIOSEnter > Date.now() - 225 &&
            (!w || o.some((k) => k.nodeName == "DIV" || k.nodeName == "P"))) ||
            (!w &&
    ...
    if (
        ...
        Eg(d, p.start, p.endA, m, g) &&
        t.someProp("handleKeyDown", (k) => k(t, Ut(8, "Backspace")))
    ) {
        mt && de && t.domObserver.suppressSelectionUpdates();
        return;
    }
    (de && p.endB == p.start && (t.input.lastChromeDelete = Date.now()),
        mt &&
            !w &&
            m.start() != g.start() &&
            g.parentOffset == 0 &&
                ...
                T &&
                    !(
                        (de &&
                            ...
                            (T.head == b || T.head == O.mapping.map(C) - 1)) ||
                        (ve && T.empty && T.head == b)
                    ) &&
                    O.setSelection(T);
            }
    ...
    if (w)
        if (m.pos == g.pos) {
            ve &&
                ...
                setTimeout(() => gt(t), 20));
            let k = x(t.state.tr.delete(b, C)),
                O = d.resolve(p.start).marksAcross(d.resolve(p.endA));
            (O && k.ensureMarks(O), t.dispatch(k));
        } else if (
            p.endA == p.endB &&
            (S = Ag(
            ...
            let k = x(t.state.tr);
            (S.type == "add"
                ? k.addMark(b, C, S.mark)
                : k.removeMark(b, C, S.mark),
                t.dispatch(k));
        } else if (
            ...
            let k = m.parent.textBetween(m.parentOffset, g.parentOffset),
                O = () => x(t.state.tr.insertText(k, b, C));
            t.someProp("handleTextInput", (T) => T(t, b, C, k, O)) ||
                t.dispatch(O());
        } else t.dispatch(x());
    else t.dispatch(x());
}
function jc(t, e, n) {
    return Math.max(n.anchor, n.head) > e.content.size
        ? null
        : Ds(t, e.resolve(n.anchor), e.resolve(n.head));
}
function Ag(t, e) {
...
function Eg(t, e, n, r, o) {
    if (n - e <= o.pos - r.pos || us(r, !0, !1) < o.pos) return !1;
    let i = t.resolve(e);
    if (!r.parent.isTextblock) {
        let l = i.nodeAfter;
    ...
    if (i.parentOffset < i.parent.content.size || !i.parent.isTextblock)
        return !1;
    let s = t.resolve(us(i, !0, !0));
    return !s.parent.isTextblock || s.pos > n || us(s, !0, !1) < n
        ? !1
...
var tr = class {
    constructor(e, n) {
        ((this._root = null),
            ...
            (this.editable = Jc(this)),
            qc(this),
            (this.nodeViews = Gc(this)),
            (this.docView = Tc(
                this.state.doc,
                Kc(this),
                ds(this),
            ...
            (this.domObserver = new Ns(this, (r, o, i, s) =>
                Tg(this, r, o, i, s),
            )),
    ...
    update(e) {
        ...
        ((this._props = e),
            e.plugins &&
                (e.plugins.forEach(Xc), (this.directPlugins = e.plugins)),
    ...
    updateStateInner(e, n) {
        ...
        let o = this.state,
            i = !1,
            s = !1;
        (e.storedMarks && this.composing && (Sd(this), (s = !0)),
            (this.state = e));
        ...
        if (
            ...
            let h = Gc(this);
            Rg(h, this.nodeViews) && ((this.nodeViews = h), (i = !0));
        }
        ((l || n.handleDOMEvents != this._props.handleDOMEvents) && Ms(this),
            (this.editable = Jc(this)),
            qc(this));
        let a = ds(this),
            c = Kc(this),
            d =
                o.plugins != e.plugins && !o.doc.eq(e.doc)
                    ...
                    : e.scrollToSelection > o.scrollToSelection
                      ? "to selection"
                      : "preserve",
            u = i || !this.docView.matchesNode(e.doc, c, a);
        ...
        if (s) {
            ...
            !(
                ...
                ? gt(this, h)
                : (dd(this, e.selection), this.domObserver.setCurSelection()),
                this.domObserver.start());
        }
    ...
    endOfTextblock(e, n) {
        return Tm(this, n || this.state, e);
    }
    pasteHTML(e, n) {
        return Zn(this, "", e, !1, n || new ClipboardEvent("paste"));
    }
    pasteText(e, n) {
        return Zn(this, e, null, !0, n || new ClipboardEvent("paste"));
    }
...
tr.prototype.dispatch = function (t) {
...
var yt = {
    ...
    Dg = typeof navigator < "u" && /Mac/.test(navigator.platform),
    Ig =
        typeof navigator < "u" &&
        /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(
            navigator.userAgent,
        );
for (le = 0; le < 10; le++) yt[48 + le] = yt[96 + le] = String(le);
var le;
for (le = 1; le <= 24; le++) yt[le + 111] = "F" + le;
var le;
for (le = 65; le <= 90; le++)
    ((yt[le] = String.fromCharCode(le + 32)),
        (to[le] = String.fromCharCode(le)));
var le;
for (eo in yt) to.hasOwnProperty(eo) || (to[eo] = yt[eo]);
var eo;
function Ed(t) {
    var e =
            (Dg && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey) ||
            (Ig && t.shiftKey && t.key && t.key.length == 1) ||
            t.key == "Unidentified",
        n =
            (!e && t.key) ||
            (t.shiftKey ? to : yt)[t.keyCode] ||
            t.key ||
            "Unidentified";
    return (
        n == "Esc" && (n = "Escape"),
...
var Pg =
    ...
    Lg = typeof navigator < "u" && /Win/.test(navigator.platform);
function Bg(t) {
    let e = t.split(/-(?!$)/),
        n = e[e.length - 1];
    n == "Space" && (n = " ");
    ...
    for (let l = 0; l < e.length - 1; l++) {
        ...
        else if (/^mod$/i.test(a)) Pg ? (s = !0) : (o = !0);
...
function Nd(t) {
    return new P({ props: { handleKeyDown: or(t) } });
}
function or(t) {
    let e = zg(t);
    return function (n, r) {
...
var Hg = Object.defineProperty,
    js = (t, e) => {
        for (var n in e) Hg(t, n, { get: e[n], enumerable: !0 });
    };
function co(t) {
        ...
        buildProps(t, e = !0) {
            let { rawCommands: n, editor: r, state: o } = this,
                ...
                s = {
                    ...
                    editor: r,
                    view: i,
                    state: co({ state: o, transaction: t }),
                    dispatch: e ? () => {} : void 0,
...
js(Hd, {
    ...
    clearNodes: () => Vg,
    command: () => _g,
    createParagraphNear: () => Wg,
    cut: () => jg,
    deleteCurrentNode: () => Ug,
    deleteNode: () => Kg,
    deleteRange: () => qg,
    deleteSelection: () => Jg,
    enter: () => Gg,
    ...
    jg =
        ...
        ({ editor: n, tr: r }) => {
            ...
            return (
                ...
                r.setSelection(new D(r.doc.resolve(Math.max(s - 1, 0)))),
                !0
            );
        },
    Ug =
...
function Ks(t, e, n) {
    ...
    let s = o.index,
        ...
        a = s + 1,
        c = l + o.node.nodeSize;
    for (; s > 0 && Od([...t.parent.child(s - 1).marks], e, n); )
        ((s -= 1), (l -= t.parent.child(s).nodeSize));
    for (; a < t.parent.childCount && Od([...t.parent.child(a).marks], e, n); )
...
function Fd(t, e = null) {
    ...
    let o = n.from,
        i = r.to;
    return e === "all"
        ? D.create(t, bt(0, o, i), bt(t.content.size, o, i))
        : D.create(t, bt(e, o, i), bt(e, o, i));
}
function Zg() {
    return (
...
var ey =
        ...
        ({ editor: n, view: r, tr: o, dispatch: i }) => {
            ...
            if (i && t === null && !fo(n.state.selection)) return (s(), !0);
            let l = Fd(o.doc, t) || n.state.selection,
    ...
    ty = (t, e) => (n) => t.every((r, o) => e(r, { ...n, index: o })),
    ny =
        (t, e) =>
        ({ tr: n, commands: r }) =>
            r.insertContentAt(
...
function ir(t, e, n) {
    if (t instanceof ie || t instanceof v) return t;
    ...
    if (o) {
        if (n.errorOnInvalidContent) {
            ...
            if (
                (n.slice
                    ? Xe.fromSchema(a).parseSlice(no(t), n.parseOptions)
                    : Xe.fromSchema(a).parse(no(t), n.parseOptions),
        ...
        let i = Xe.fromSchema(e);
        return n.slice
            ? i.parseSlice(no(t), n.parseOptions).content
            : i.parse(no(t), n.parseOptions);
    }
    return ir("", e, n);
}
function ry(t, e, n) {
...
var oy = (t) => !("type" in t),
            ...
            if (o) {
                ...
                if (f) {
                    ...
                    let g = r.doc.resolve(d),
                        ...
                        C = y.content.size > 0;
                    (w && b && C && (d = Math.max(0, d - 1)),
                        r.replaceWith(d, u, m));
                }
                (n.updateSelection && ry(r, r.steps.length - 1, -1),
                    n.applyInputRules &&
    ...
    dy =
        ...
        ({ state: t, dispatch: e, tr: n }) => {
            try {
                let r = Wt(t.doc, t.selection.$from.pos, -1);
...
function py(t) {
    ...
    for (let l = 0; l < e.length - 1; l += 1) {
        ...
        else if (/^mod$/i.test(a)) qs() || _d() ? (s = !0) : (o = !0);
        else throw new Error(`Unrecognized modifier name: ${a}`);
    }
    return (
        r && (n = `Alt-${n}`),
...
function Ze(t, e, n = {}) {
    ...
    let a = o - r,
        c = l
            ...
            .filter((u) => lo(u.node.attrs, n, { strict: !1 }));
...
var xy =
        ...
        ({ tr: n, state: r, dispatch: o }) => {
            let i = null,
                s = null,
                l = ho(typeof t == "string" ? t : t.name, r.schema);
            if (!l) return !1;
            (l === "node" && (i = ne(t, r.schema)),
                l === "mark" && (s = wt(t, r.schema)));
            let a = !1;
            return (
                n.selection.ranges.forEach((c) => {
                    r.doc.nodesBetween(c.$from.pos, c.$to.pos, (d, u) => {
                        (i &&
                            i === d.type &&
                            ((a = !0),
                            o && n.setNodeMarkup(u, void 0, Rd(d.attrs, e))),
                            s &&
                                d.marks.length &&
                                d.marks.forEach((f) => {
                                    s === f.type &&
...
function Ys(t, e) {
    let n = ct.fromSchema(e).serializeFragment(t),
...
function G(t, e = void 0, ...n) {
    return Ud(t) ? (e ? t.bind(e)(...n) : t(...n)) : t;
}
function Ny(t = {}) {
...
function Kd(t) {
    let e = [],
        { nodeExtensions: n, markExtensions: r } = An(t),
        o = [...n, ...r],
        i = {
            default: null,
            validate: void 0,
...
function Ry(t, e) {
    var n;
    let r = Kd(t),
        { nodeExtensions: o, markExtensions: i } = An(t),
        s = (n = o.find((c) => B(c, "topNode"))) == null ? void 0 : n.name,
        l = Object.fromEntries(
            o.map((c) => {
                let d = r.filter((y) => y.type === c.name),
                    ...
                    f = t.reduce((y, w) => {
                        let b = B(w, "extendNodeSchema", u);
                        return { ...y, ...(b ? b(c) : {}) };
                    }, {}),
                    h = Id({
                        ...f,
                        content: G(B(c, "content", u)),
                        marks: G(B(c, "marks", u)),
                        group: G(B(c, "group", u)),
                        inline: G(B(c, "inline", u)),
                        atom: G(B(c, "atom", u)),
                        selectable: G(B(c, "selectable", u)),
                        draggable: G(B(c, "draggable", u)),
                        code: G(B(c, "code", u)),
                        whitespace: G(B(c, "whitespace", u)),
                        linebreakReplacement: G(
                            B(c, "linebreakReplacement", u),
                        ),
                        defining: G(B(c, "defining", u)),
                        isolating: G(B(c, "isolating", u)),
                        attrs: Object.fromEntries(d.map(Pd)),
                    }),
                    p = G(B(c, "parseHTML", u));
                p && (h.parseDOM = p.map((y) => Dd(y, d)));
                let m = B(c, "renderHTML", u);
                m &&
                    (h.toDOM = (y) => m({ node: y, HTMLAttributes: ao(y, d) }));
                let g = B(c, "renderText", u);
        ...
        a = Object.fromEntries(
            i.map((c) => {
                let d = r.filter((g) => g.type === c.name),
                    ...
                    f = t.reduce((g, y) => {
                        let w = B(y, "extendMarkSchema", u);
                        return { ...g, ...(w ? w(c) : {}) };
                    }, {}),
                    h = Id({
                        ...f,
                        inclusive: G(B(c, "inclusive", u)),
                        excludes: G(B(c, "excludes", u)),
                        group: G(B(c, "group", u)),
                        spanning: G(B(c, "spanning", u)),
                        code: G(B(c, "code", u)),
                        attrs: Object.fromEntries(d.map(Pd)),
                    }),
                    p = G(B(c, "parseHTML", u));
                p && (h.parseDOM = p.map((g) => Dd(g, d)));
                let m = B(c, "renderHTML", u);
                return (
                    m &&
                        (h.toDOM = (g) =>
                            m({ mark: g, HTMLAttributes: ao(g, d) })),
                    [c.name, h]
                );
            }),
        );
    return new fn({ topNode: s, nodes: l, marks: a });
}
function Dy(t) {
...
function Zs(t, e) {
    let n = ho(typeof e == "string" ? e : e.name, t.schema);
    return n === "node" ? Py(t, e) : n === "mark" ? Wd(t, e) : {};
}
function Ly(t, e = JSON.stringify) {
    let n = {};
    return t.filter((r) => {
        let o = e(r);
...
function Ws(t, e, n = {}) {
    ...
    if (
        (o.forEach(({ $from: u, $to: f }) => {
            ...
            t.doc.nodesBetween(h, p, (m, g) => {
                ...
                let y = Math.max(h, g),
                    w = Math.min(p, g + m.nodeSize),
                    b = w - y;
                ((s += b),
                    l.push(
                        ...m.marks.map((C) => ({ mark: C, from: y, to: w })),
                    ));
            });
        }),
        s === 0)
    ...
    let a = l
            ...
            .filter((u) => lo(u.mark.attrs, n, { strict: !1 }))
...
function tl(t, e, n = {}) {
    if (!e) return Ze(t, null, n) || Ws(t, null, n);
    let r = ho(e, t.schema);
    return r === "node" ? Ze(t, e, n) : r === "mark" ? Ws(t, e, n) : !1;
}
var Yd = (t, e) => {
        let { $from: n, $to: r, $anchor: o } = t.selection;
        if (e) {
            let i = et((l) => l.type.name === e)(t.selection);
            if (!i) return !1;
...
function lr(t, { checkChildren: e = !0, ignoreWhitespace: n = !1 } = {}) {
    var r;
    if (n) {
    ...
    if (e) {
        ...
        return (
            t.content.forEach((i) => {
                o !== !1 &&
                    (lr(i, { ignoreWhitespace: n, checkChildren: e }) ||
                        (o = !1));
            }),
            o
        );
...
function Hy(t, e) {
    ...
    return { position: new Zd(n.pos), mapResult: n };
}
function $y(t) {
    return new Zd(t);
}
        ...
        ({ tr: n, state: r, dispatch: o }) => {
            ...
            return (
                ...
                o &&
                    n.doc.nodesBetween(s, l, (a, c) => {
                        a.isText ||
                            n.setNodeMarkup(c, void 0, { ...a.attrs, dir: t });
                    }),
                !0
            );
        },
...
var Jy =
        ...
        ({ tr: e, state: n, dispatch: r, editor: o }) => {
            let { selection: i, doc: s } = e,
                ...
                d = so(c, l.node().type.name, l.node().attrs);
            if (i instanceof L && i.node.isBlock)
                return !l.parentOffset || !Ee(s, l.pos)
                    ? !1
                    : (r &&
                          (t && zd(n, o.extensionManager.splittableMarks),
            ...
            let u = a.parentOffset === a.parent.content.size,
                f =
                    l.depth === 0
                        ? void 0
                        : sr(l.node(-1).contentMatchAt(l.indexAfter(-1))),
                h = u && f ? [{ type: f, attrs: d }] : void 0,
                p = Ee(e.doc, e.mapping.map(l.pos), 1, h);
            if (
                (!h &&
                    !p &&
                    Ee(
    ...
    Gy =
        ...
        ({ tr: n, state: r, dispatch: o, editor: i }) => {
            ...
            if (
                ...
                if (o) {
                    let y = v.empty,
                        w = a.index(-1) ? 1 : a.index(-2) ? 2 : 3;
                    for (let O = a.depth - w; O >= a.depth - 3; O -= 1)
                        y = v.from(a.node(O).copy(y));
                    let b =
                            a.indexAfter(-1) < a.node(-2).childCount
                                ...
                                : a.indexAfter(-2) < a.node(-3).childCount
                                  ...
                                  : 3,
                        C = {
                            ...so(f, a.node().type.name, a.node().attrs),
                            ...e,
                        },
                        x =
                    ...
                    y = y.append(v.from(l.createAndFill(null, x) || void 0));
                    let S = a.before(a.depth - (w - 1));
                    n.replace(S, a.after(-b), new E(y, 4 - w, 0));
                    let k = -1;
                    (n.doc.nodesBetween(S, n.doc.content.size, (O, T) => {
                        if (k > -1) return !1;
                        O.isTextblock && O.content.size === 0 && (k = T + 1);
                    }),
                        k > -1 && n.setSelection(D.near(n.doc.resolve(k))),
                        n.scrollIntoView());
                }
                return !0;
            }
            let h = c.pos === a.end() ? u.contentMatchAt(0).defaultType : null,
                p = { ...so(f, u.type.name, u.attrs), ...e },
                m = { ...so(f, a.node().type.name, a.node().attrs), ...e };
            ...
            let g = h
                ...
                : [{ type: l, attrs: p }];
            if (!Ee(n.doc, a.pos, 2)) return !1;
            if (o) {
                let { selection: y, storedMarks: w } = r,
                    { splittableMarks: b } = i.extensionManager,
                    C = w || (y.$to.parentOffset && y.$from.marks());
                if ((n.split(a.pos, 2, g).scrollIntoView(), !C || !o))
                    return !0;
                let x = C.filter((S) => b.includes(S.type.name));
                n.ensureMarks(x);
            }
            return !0;
        },
    Fs = (t, e) => {
        let n = et((s) => s.type === e)(t.selection);
        if (!n) return !0;
        let r = t.doc.resolve(Math.max(0, n.pos - 1)).before(n.depth);
        if (r === void 0) return !0;
        let o = t.doc.nodeAt(r);
        return (
            n.node.type === o?.type && Re(t.doc, n.pos) && t.join(n.pos),
            !0
        );
    },
    Vs = (t, e) => {
        ...
        if (r === void 0) return !0;
        let o = t.doc.nodeAt(r);
        return (n.node.type === o?.type && Re(t.doc, r) && t.join(r), !0);
    },
    Xy =
        (t, e, n, r = {}) =>
        ({
            ...
            return !n || !C || !l
                ...
                : a()
                      .command(() => {
                          let S = d().wrapInList(h, r),
                              k = C.filter((O) => f.includes(O.type.name));
                          return (i.ensureMarks(k), S ? !0 : c.clearNodes());
                      })
                      .wrapInList(h, r)
                      .command(() => Fs(i, h))
                      .command(() => Vs(i, h))
    ...
    Zy =
        ...
        ({ state: n, commands: r }) => {
            let o = ne(t, n.schema);
            return Ze(n, o, e) ? r.lift(o) : r.wrapIn(o, e);
        },
    eb =
        () =>
        ({ state: t, dispatch: e }) => {
...
function ro(t) {
    ...
    return (
        s.forEach((f) => {
            ...
            if (!h) return;
            let p = a.state.tr,
                m = co({ state: a.state, transaction: p }),
                g = { from: r - (h[0].length - i.length), to: o },
                {
                    commands: y,
                    chain: w,
                    can: b,
                } = new uo({ editor: n, state: m });
            f.handler({
                state: m,
                range: g,
                match: h,
    ...
    return (
        oo(t) &&
            ...
            Object.keys(e).forEach((r) => {
                oo(e[r]) && oo(t[r]) ? (n[r] = nu(t[r], e[r])) : (n[r] = e[r]);
            }),
        n
    );
}
var nl = class {
        ...
        get options() {
            return { ...(G(B(this, "addOptions", { name: this.name })) || {}) };
        }
        get storage() {
            return {
                ...(G(
...
function pb(t) {
    let {
        ...
        { commands: a, chain: c, can: d } = new uo({ editor: e, state: n }),
        u = [];
    return (
        n.doc.nodesBetween(r, o, (h, p) => {
            ...
            let C =
                    (b =
                        (w = (y = h.content) == null ? void 0 : y.size) != null
                            ? w
                            : h.nodeSize) != null
                        ? b
                        : 0,
            ...
            hb(k, i.find, s).forEach((T) => {
                if (T.index === void 0) return;
                let A = x + T.index + 1,
                    $ = A + T[0].length,
                    z = { from: n.tr.mapping.map(A), to: n.tr.mapping.map($) },
                    K = i.handler({
                        state: n,
                        range: z,
                        match: T,
...
var yo = class {
    constructor(t, e) {
        ((this.splittableMarks = []),
            ...
            (this.extensions = qd(t)),
            (this.schema = Ry(this.extensions, e)),
    ...
    get plugins() {
        let { editor: t } = this;
        return Qs([...this.extensions].reverse()).flatMap((r) => {
            let o = {
                    name: r.name,
                    options: r.options,
            ...
            let a = Nd(l);
            i.push(a);
            let c = B(r, "addInputRules", o);
            if (Ld(r, t.options.enableInputRules) && c) {
                let f = c();
                if (f && f.length) {
                    let h = cb({ editor: t, rules: f }),
                        p = Array.isArray(h) ? h : [h];
                    i.push(...p);
                }
            }
            let d = B(r, "addPasteRules", o);
            if (Ld(r, t.options.enablePasteRules) && d) {
                let f = d();
                if (f && f.length) {
                    let h = gb({ editor: t, rules: f });
                    i.push(...h);
                }
            }
            let u = B(r, "addProseMirrorPlugins", o);
            if (u) {
                let f = u();
                i.push(...f);
            }
    ...
    setupExtensions() {
        ...
        ((this.editor.extensionStorage = Object.fromEntries(
            ...
            t.forEach((e) => {
                ...
                e.type === "mark" &&
                    ((n = G(B(e, "keepOnSplit", r))) == null || n) &&
                    this.splittableMarks.push(e.name);
                let o = B(e, "onBeforeCreate", r),
                    i = B(e, "onCreate", r),
                    s = B(e, "onUpdate", r),
                    l = B(e, "onSelectionUpdate", r),
                    a = B(e, "onTransaction", r),
                    c = B(e, "onFocus", r),
                    d = B(e, "onBlur", r),
                    u = B(e, "onDestroy", r);
...
js(yb, {
    ...
    Tabindex: () => pu,
    TextDirection: () => mu,
    focusEventsPluginKey: () => du,
});
var U = class ou extends nl {
        constructor() {
                ...
                d.steps.forEach((h, p) => {
                    ...
                    if (h instanceof ut) {
                        let y = f.slice(p).map(h.from, -1),
                            w = f.slice(p).map(h.to),
                            b = f.invert().map(y, -1),
                            C = f.invert().map(w),
                            x =
                                (m = d.doc.nodeAt(y - 1)) == null
                                    ? void 0
                                    : m.marks.some((k) => k.eq(h.mark)),
                            S =
                                (g = d.doc.nodeAt(w)) == null
                                    ? void 0
                                    : g.marks.some((k) => k.eq(h.mark));
                        this.editor.emit("delete", {
                            type: "mark",
                            mark: h.mark,
                            from: h.from,
                            to: h.to,
                            deletedRange: { from: b, to: C },
                            newRange: { from: y, to: w },
                            partial: !!(S || x),
                            editor: this.editor,
                            transaction: t,
                            combinedTransform: d,
                ...
                new P({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        let { empty: i, from: s, to: l } = e.selection,
                            ...
                            c = I.atEnd(e.doc).to;
                        if (i || !(s === a && l === c) || !lr(n.doc)) return;
                        let f = n.tr,
                            h = co({ state: n, transaction: f }),
                            { commands: p } = new uo({
                                editor: this.editor,
                                state: h,
                            });
    ...
    mu = U.create({
        ...
        addGlobalAttributes() {
            ...
            let { nodeExtensions: t } = An(this.extensions);
            return [
                {
                    types: t
        ...
        get children() {
            ...
            return (
                this.node.content.forEach((n, r) => {
                    ...
                    let a = new Tn(l, this.editor, o, o ? n : null);
                    (o && (a.actualDepth = this.depth + 1),
                        e.push(new Tn(l, this.editor, o, o ? n : null)));
                }),
                e
            );
        }
...
var gu = class extends lb {
    constructor(t = {}) {
        (super(),
            ...
            (this.utils = {
                getUpdatedPosition: Hy,
                createMappablePosition: $y,
            }),
            this.setOptions(t),
    ...
    injectCSS() {
        this.options.injectCSS &&
            typeof document < "u" &&
            (this.css = xb(wb, this.options.injectNonce));
    }
    setOptions(t = {}) {
    ...
    createExtensionManager() {
        ...
        let r = [
            ...(this.options.enableCoreExtensions
                ? [
                      ...
                      hu,
                      lu,
                      mu.configure({ direction: this.options.textDirection }),
                  ].filter((o) =>
        ...
        this.extensionManager = new yo(r, this);
    }
    createCommandManager() {
        this.commandManager = new uo({ editor: this });
    }
    createSchema() {
...
`,
        ...
        return Iy(this.state.doc, {
            blockSeparator: e,
            textSerializers: { ...Gd(this.schema), ...n },
        });
    }
    get isEmpty() {
        return lr(this.state.doc);
    }
    destroy() {
...
function Be(t) {
    return new go({
        ...
        handler: ({ state: e, range: n, match: r }) => {
            let o = G(t.getAttributes, void 0, r);
...
function tt(t) {
    return new go({
        ...
        handler: ({ state: e, range: n, match: r, chain: o }) => {
            let i = G(t.getAttributes, void 0, r) || {},
...
var kb = (t) => "touches" in t,
    yu = class {
        constructor(t) {
            ((this.directions = [
                ...
                (this.handleTouchMove = (l) => {
                    ...
                    let a = l.touches[0];
                    if (!a) return;
                    let c = a.clientX - this.startX,
                        d = a.clientY - this.startY;
                    this.handleResize(c, d);
                }),
                (this.handleMouseUp = () => {
                    if (!this.isResizing) return;
                    let l = this.element.offsetWidth,
        ...
        handleEditorUpdate() {
            ...
            t !== this.lastEditableState &&
                ((this.lastEditableState = t),
                t
                    ? t && this.handleMap.size === 0 && this.attachHandles()
                    : this.removeHandles());
        }
        update(t, e, n) {
            return t.type !== this.node.type
                ? !1
                : ((this.node = t),
                  this.onUpdate ? this.onUpdate(t, e, n) : !0);
        }
        destroy() {
            (this.isResizing &&
                ((this.container.dataset.resizeState = "false"),
        ...
        createWrapper() {
            ...
            return (
                ...
                this.classNames.wrapper &&
                    (t.className = this.classNames.wrapper),
        ...
        createHandle(t) {
            ...
            return (
                ...
                this.classNames.handle &&
                    (e.className = this.classNames.handle),
                e
            );
        }
        positionHandle(t, e) {
        ...
        handleResize(t, e) {
            ...
            let n = this.preserveAspectRatio || this.isShiftKeyPressed,
                { width: r, height: o } = this.calculateNewDimensions(
                    this.activeHandle,
                    t,
                    e,
                ),
        ...
        calculateNewDimensions(t, e, n) {
            ...
            return (
                ...
                l
                    ? (o = this.startHeight + n)
                    : a && (o = this.startHeight - n),
                (t === "right" || t === "left") &&
...
var Sb = {};
js(Sb, {
    createAtomBlockMarkdownSpec: () => Cb,
    createBlockMarkdownSpec: () => Zt,
    createInlineMarkdownSpec: () => Tb,
    parseAttributes: () => rl,
    parseIndentedBlocks: () => wo,
    renderNestedMarkdownContent: () => cr,
    serializeAttributes: () => ol,
});
function rl(t) {
    if (!t?.trim()) return {};
    let e = {},
...
function Cb(t) {
    let {
            nodeName: e,
            name: n,
            parseAttributes: r = rl,
            serializeAttributes: o = ol,
            defaultAttributes: i = {},
...
function Zt(t) {
    let {
            ...
            name: n,
            getContent: r,
            parseAttributes: o = rl,
            serializeAttributes: i = ol,
            defaultAttributes: s = {},
            content: l = "block",
            allowedAttributes: a,
        } = t,
                ...
                for (k.lastIndex = 0; ; ) {
                    ...
                    if (!((p = T[2]) != null && p.endsWith(":::"))) {
                        if ($) C += 1;
                            ...
                            let z = O.slice(0, A);
                            S = z.trim();
                            let K = u.slice(0, x + A + T[0].length),
                                V = [];
                            if (S)
                                if (l === "block")
                                    for (
...
function Tb(t) {
    let {
            ...
            name: n,
            getContent: r,
            parseAttributes: o = vb,
            serializeAttributes: i = Mb,
            defaultAttributes: s = {},
            selfClosing: l = !1,
            allowedAttributes: a,
        } = t,
    ...
    return {
        ...
        markdownTokenizer: {
            ...
            tokenize(f, h, p) {
                ...
                let b = o(w.trim());
                return { type: e, raw: g[0], content: y.trim(), attributes: b };
            },
        },
        renderMarkdown: (f) => {
            let h = "";
...
`;
        ...
        for (d += 1; d < l.length; ) {
            let x = l[d];
            if (x.trim() === "") {
                let k = l.slice(d + 1).findIndex((A) => A.trim() !== "");
                if (k === -1) break;
                if (
                    (((o =
                        (r = l[d + 1 + k].match(/^(\s*)/)) == null
                            ? void 0
                            : r[1]) == null
                        ? void 0
                        : o.length) || 0) > m
...
`),
        ...
        let w,
            b = y.slice(1);
        if (b.length > 0) {
            let x = b.map((S) => S.slice(m + u)).join(`
`);
            x.trim() &&
                (e.customNestedParser
                    ? (w = e.customNestedParser(x))
                    : (w = n.blockTokens(x)));
        }
        let C = e.createToken(p, w);
        a.push(C);
    }
...
function Me(t) {
    return new fb({
        ...
        handler: ({ state: e, range: n, match: r, pasteEvent: o }) => {
            let i = G(t.getAttributes, void 0, r, o);
...
var ae = class t extends I {
    ...
    getBookmark() {
        return new sl(this.anchor);
    }
    static valid(e) {
        let n = e.parent;
        if (n.isTextblock || !Eb(e) || !Nb(e)) return !1;
...
var sl = class t {
    ...
    resolve(e) {
        ...
        return ae.valid(n) ? new ae(n) : I.near(n);
    }
};
function Su(t) {
...
function Eb(t) {
    for (let e = t.depth; e >= 0; e--) {
        ...
        for (let o = r.child(n - 1); ; o = o.lastChild) {
            if ((o.childCount == 0 && !o.inlineContent) || Su(o.type))
                return !0;
    ...
    return new P({
        props: {
            ...
            createSelectionBetween(t, e, n) {
                return e.pos == n.pos && ae.valid(n) ? new ae(n) : null;
            },
            handleClick: Rb,
            handleKeyDown: Ob,
...
function Db(t, e) {
    ...
    let i = t.state.tr.replace(n.pos, n.pos, new E(o, 0, 0));
    return (
        i.setSelection(D.near(i.doc.resolve(n.pos + 1))),
        t.dispatch(i),
        !1
    );
}
function Ib(t) {
    ...
    return (
        ...
        Y.create(t.doc, [te.widget(t.selection.head, e, { key: "gapcursor" })])
    );
}
var ko = 200,
    he = function () {};
he.prototype.append = function (e) {
    return e.length
        ? ((e = he.from(e)),
          (!this.length && e) ||
              (e.length < ko && this.leafAppend(e)) ||
              (this.length < ko && e.leafPrepend(this)) ||
              this.appendInner(e))
        : this;
};
...
he.from = function (e) {
    return e instanceof he ? e : e && e.length ? new vu(e) : he.empty;
};
var vu = (function (t) {
    function e(r) {
    ...
    tn = class t {
        ...
        addMaps(e) {
            return this.eventCount == 0
                ? this
                : new t(
                      this.items.append(e.map((n) => new nt(n))),
                      this.eventCount,
                  );
        }
        rebased(e, n) {
            ...
            this.items.forEach((f) => {
                ...
                if (f.step) {
                    ...
                    (g && l++, r.push(new nt(p, m, g)));
                } else r.push(new nt(p));
            }, o);
            let c = [];
            for (let f = n; f < s; f++) c.push(new nt(i.maps[f]));
        ...
        compress(e = this.items.length) {
            ...
            return (
                ...
                new t(ll.from(o.reverse()), i)
            );
        }
    };
tn.empty = new tn(ll.empty, 0);
function Bb(t, e) {
    let n;
    return (
        t.forEach((r, o) => {
...
function Hb(t, e, n, r) {
    ...
    n.getMeta(Vb) && (t = new rt(t.done, t.undone, null, 0, -1));
    let s = n.getMeta("appendedTransaction");
    if (n.steps.length == 0) return t;
    if (s && s.getMeta(en))
        return s.getMeta(en).redo
            ? new rt(
                  t.done.addTransform(n, void 0, r, So(e)),
                  t.undone,
                  Mu(n.mapping.maps),
                  t.prevTime,
                  t.prevComposition,
            ...
            : new rt(
                  t.done,
                  t.undone.addTransform(n, void 0, r, So(e)),
                  null,
                  t.prevTime,
                  t.prevComposition,
              );
            ...
            a =
                ...
                (!s &&
                    ...
                    (t.prevTime < (n.time || 0) - r.newGroupDelay ||
                        !$b(n, t.prevRanges))),
            c = s ? al(t.prevRanges, n.mapping) : Mu(n.mapping.maps);
        return new rt(
            t.done.addTransform(
                n,
...
function Fb(t, e, n) {
    ...
    let s = i.selection.resolve(i.transform.doc),
        ...
        a = new rt(n ? l : i.remaining, n ? i.remaining : l, null, 0, -1);
    return i.transform
        .setSelection(s)
        .setMeta(en, { redo: n, historyState: a });
}
var cl = !1,
    Tu = null;
function So(t) {
...
var en = new H("history"),
    Vb = new H("closeHistory");
function Au(t = {}) {
    return (
        ...
        new P({
            ...
            state: {
                init() {
                    return new rt(tn.empty, tn.empty, null, 0, -1);
                },
                apply(e, n, r) {
                    return Hb(n, r, e, t);
                },
...
var C1 = U.create({
    ...
    Ou = U.create({
        ...
        extendNodeSchema(t) {
            ...
            return {
                allowGapCursor:
                    (e = G(B(t, "allowGapCursor", n))) != null ? e : null,
            };
        },
    }),
    fl = U.create({
                ...
                new P({
                    ...
                    state: {
                        init: (o, i) => {
                            ...
                            return !Eu({ node: s, types: r });
                        },
                        apply: (o, i) => {
                            if (
                                !o.docChanged ||
                                o.getMeta("__uniqueIDTransaction")
                            )
                                return i;
...
`)
        ...
        addInputRules() {
            return [tt({ find: _b, type: this.type })];
        },
    }),
    Du = Wb;
var jb = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,
    Ub = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g,
    Kb = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/,
    qb = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g,
    Jb = ee.create({
        name: "bold",
        addOptions() {
            return { HTMLAttributes: {} };
        ...
        addInputRules() {
            return [
                Be({ find: jb, type: this.type }),
                Be({ find: Kb, type: this.type }),
            ];
        },
        addPasteRules() {
            return [
                Me({ find: Ub, type: this.type }),
                Me({ find: qb, type: this.type }),
            ];
        },
    }),
    Iu = Jb;
var Gb = /(^|[^`])`([^`]+)`(?!`)$/,
    ...
    Yb = ee.create({
        ...
        addInputRules() {
            return [Be({ find: Gb, type: this.type })];
        },
        addPasteRules() {
            return [Me({ find: Xb, type: this.type })];
        },
    }),
    Pu = Yb;
var hl = 4,
        ...
        addKeyboardShortcuts() {
            return {
                ...
                Tab: ({ editor: t }) => {
                    ...
                    let n = (e = this.options.tabSize) != null ? e : hl,
                        { state: r } = t,
                        { selection: o } = r,
                        { $from: i, empty: s } = o;
...
`),
                                ...
                                return (
                                    l.delete(C, C + b),
                                    c - C <= b &&
                                        l.setSelection(D.create(l.doc, C)),
                                    !0
                                );
                            })
                          : t.commands.command(({ tr: l }) => {
...
var vo = (t, e) => e.view.domAtPos(t).node.offsetParent !== null,
    t0 = (t, e, n) => {
    ...
    zu = (t, e) => {
        ...
        if (
            ...
            return !1;
        let d = et((y) => y.type === i.nodes.details)(s);
        if (!d) return !1;
        let u = En(d.node, (y) => y.type === i.nodes.detailsContent);
        if (!u.length || vo(d.start + u[0].pos + 1, t)) return !1;
    ...
    Hu = F.create({
        ...
        ...Zt({ nodeName: "details", content: "block" }),
        addNodeView() {
            return ({ editor: t, getPos: e, node: n, HTMLAttributes: r }) => {
                ...
                let a = (c) => {
                    ...
                    let d = new Event("toggleDetailsContent"),
                        u = l.querySelector(
                ...
                return (
                    ...
                    s.addEventListener("click", () => {
                        ...
                        if (t.isEditable && typeof e == "function") {
                            let { from: c, to: d } = t.state.selection;
                            t.chain()
                                .command(({ tr: u }) => {
                                    let f = e();
                                    if (!f) return !1;
                                    let h = u.doc.nodeAt(f);
        ...
        addKeyboardShortcuts() {
            return {
                ...
                ArrowRight: ({ editor: t }) => zu(t, "right"),
                ArrowDown: ({ editor: t }) => zu(t, "down"),
            };
        },
        addProseMirrorPlugins() {
            return [
                new P({
                    ...
                    appendTransaction: (t, e, n) => {
                        ...
                        if (vo(a.pos, r)) return;
                        let d = t0(a, (y) => y.type === o, r);
                        if (!d) return;
                        let u = En(
                            d.node,
        ...
        addKeyboardShortcuts() {
            return {
                Enter: ({ editor: t }) => {
                    ...
                    let y = o.node(-3);
                    if (!y) return !1;
                    let w = o.indexAfter(-3),
                        b = sr(y.contentMatchAt(w));
                    if (!b || !y.canReplaceWith(w, w, b)) return !1;
                    let C = b.createAndFill();
                    if (!C) return !1;
                    let { tr: x } = e,
                        S = o.after(-2);
                    x.replaceWith(S, S, C);
                    let k = x.doc.resolve(S),
                        O = I.near(k, 1);
                    x.setSelection(O);
                    let T = m,
                        A = m + p.nodeSize;
    ...
    Fu = F.create({
        ...
        ...Zt({ nodeName: "detailsSummary", content: "inline" }),
    });
var n0 = F.create({
        name: "doc",
        topNode: !0,
    ...
    addCommands() {
        return {
            insertGrid:
                ...
                ({ tr: r, dispatch: o, editor: i }) => {
                    let s = i.schema.nodes.gridColumn,
                        l = Array.isArray(t) && t.length ? t : [1, 1],
                        a = [];
                    ...
                    let c = l
                            .map((u) => Number(u) || 1)
                            .reduce((u, f) => u + f, 0),
                        d = i.schema.nodes.grid.createChecked(
                            { "data-cols": c, "data-from-breakpoint": e },
                            a,
                        );
                    if (o) {
                        let u = r.selection.anchor + 1;
                        [null, void 0].includes(n?.from)
                            ? r
                                  .replaceSelectionWith(d)
                                  .scrollIntoView()
                                  .setSelection(D.near(r.doc.resolve(u)))
                            : r
                                  .replaceRangeWith(n.from, n.to, d)
                                  .scrollIntoView()
                                  .setSelection(D.near(r.doc.resolve(n.from)));
                    }
                    return !0;
                },
        };
...
var i0 = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/,
    ...
    l0 = ee.create({
        ...
        addInputRules() {
            return [Be({ find: i0, type: this.type })];
        },
        addPasteRules() {
            return [Me({ find: s0, type: this.type })];
        },
    }),
    Ku = l0;
var a0 = F.create({
        ...
        addCommands() {
            return {
                setHorizontalRule:
                    () =>
                    ({ chain: t, state: e }) => {
                        if (!bu(e, e.schema.nodes[this.name])) return !1;
                        let { selection: n } = e,
                            { $to: r } = n,
                            o = t();
                        return (
        ...
        addInputRules() {
            return [
                bo({ find: /^(?:---|—-|___\s|\*\*\*\s)$/, type: this.type }),
            ];
        },
    }),
    qu = a0;
var c0 = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/,
    ...
    h0 = ee.create({
        ...
        addInputRules() {
            return [
                Be({ find: c0, type: this.type }),
                Be({ find: u0, type: this.type }),
            ];
        },
        addPasteRules() {
            return [
                Me({ find: d0, type: this.type }),
                Me({ find: f0, type: this.type }),
            ];
        },
    }),
    Ju = h0;
var p0 = /(?:^|\s)(!\[(.+|:?)]\((\S+)(?:(?:\s+)["'](\S+)["'])?\))$/,
    m0 = F.create({
        ...
        addNodeView() {
            ...
            return ({ node: o, getPos: i, HTMLAttributes: s, editor: l }) => {
    ...
    addAttributes() {
        return {
            ...
            width: {
                ...
                renderHTML: (t) =>
                    t.width
                        ? { width: t.width, style: `width: ${t.width}` }
                        : {},
            },
            height: {
                default: null,
                parseHTML: (t) =>
                    t.getAttribute("height") || t.style.height || null,
                renderHTML: (t) =>
                    t.height
                        ? { height: t.height, style: `height: ${t.height}` }
                        : {},
            },
        };
    },
...
Te.prototype = {
    ...
    tr(t, e, n, r) {
        ...
        let o;
        return (
            e && e.j ? (o = e) : ((o = new Te(e)), n && r && nn(e, n, r)),
            this.jr.push([t, o]),
            o
        );
    },
        ...
        if (
            ...
            if (r)
                if (s.t && typeof s.t == "string") {
                    let a = Object.assign(k0(s.t, r), n);
                    nn(i, a, r);
                } else n && nn(i, n, r);
            s.t = i;
        }
...
var j = (t, e, n, r, o) => t.ta(e, n, r, o),
    re = (t, e, n, r, o) => t.tr(e, n, r, o),
    Qu = (t, e, n, r, o) => t.ts(e, n, r, o),
    ...
    zo = "LEFTCORNERBRACKET",
    Ho = "RIGHTCORNERBRACKET",
    $o = "LEFTWHITECORNERBRACKET",
    Fo = "RIGHTWHITECORNERBRACKET",
    Vo = "FULLWIDTHLESSTHAN",
    _o = "FULLWIDTHGREATERTHAN",
    Wo = "AMPERSAND",
    jo = "APOSTROPHE",
    Uo = "ASTERISK",
    Lt = "AT",
...
function v0(t = []) {
    ...
    (Mo == null && (Mo = ef(g0)),
        ...
        M(n, "\\", Ko),
        M(n, "\u30FB", af));
    let r = re(n, kt, El, { [xl]: !0 });
    re(r, kt, r);
    let o = re(r, xt, sf, { [fr]: !0 }),
        i = re(r, dr, lf, { [ur]: !0 }),
        s = re(n, xt, St, { [kl]: !0 });
    (re(s, kt, o), re(s, xt, s), re(o, kt, o), re(o, xt, o));
    let l = re(n, dr, vl, { [Sl]: !0 });
    (re(l, xt),
        re(l, kt, i),
        re(l, dr, l),
        re(i, kt, i),
    ...
    (M(n, bl, d),
        ...
        re(d, gl, d),
        M(d, bl, d));
    let u = re(n, ml, cf, { [of]: !0 });
    (M(u, "#"), re(u, ml, u), M(u, S0, u));
    let f = M(u, C0);
    (M(f, "#"), re(f, ml, u));
    let h = [
            [xt, s],
    ...
    for (let m = 0; m < Mo.length; m++) Pt(n, Mo[m], Ml, St, h);
    for (let m = 0; m < To.length; m++) Pt(n, To[m], Tl, vl, p);
    (nn(Ml, { tld: !0, ascii: !0 }, e),
        nn(Tl, { utld: !0, alpha: !0 }, e),
        Pt(n, "file", Eo, St, h),
        Pt(n, "mailto", Eo, St, h),
        Pt(n, "http", On, St, h),
        Pt(n, "https", On, St, h),
        Pt(n, "ftp", On, St, h),
        Pt(n, "ftps", On, St, h),
        nn(Eo, { scheme: !0, ascii: !0 }, e),
        nn(On, { slashscheme: !0, ascii: !0 }, e),
    ...
    return (
        Qu(n, "localhost", br, { ascii: !0 }),
        (n.jd = new Te(ti)),
        { start: n, tokens: Object.assign({ groups: e }, df) }
    );
}
function uf(t, e) {
    let n = M0(e.replace(/[A-Z]/g, (l) => l.toLowerCase())),
        r = n.length,
        o = [],
        i = 0,
        s = 0;
...
function Pt(t, e, n, r, o) {
    ...
    for (let l = 0; l < s - 1; l++) {
        ...
        (t.j[a]
            ? (i = t.j[a])
            : ((i = new Te(r)), (i.jr = o.slice()), (t.j[a] = i)),
            (t = i));
    }
    return ((i = new Te(n)), (i.jr = o.slice()), (t.j[e[s - 1]] = i), i);
}
function ef(t) {
    let e = [],
        n = [],
...
function Pl(t, e = null) {
    let n = Object.assign({}, wr);
    t && (n = Object.assign(n, t instanceof Pl ? t.o : t));
    let r = n.ignoreTags,
        o = [];
...
var nf = ni("email", {
    ...
    Ao = ni("url", {
        isLink: !0,
        toHref(t = wr.defaultProtocol) {
            return this.hasProtocol() ? this.v : `${t}://${this.v}`;
        },
        hasProtocol() {
            let t = this.tk;
            return t.length >= 2 && t[0].t !== br && t[1].t === Bt;
        },
    });
var ze = (t) => new Te(t);
function A0({ groups: t }) {
    ...
    j(f, t.domain, u);
    let h = ze(nf);
    (j(f, t.tld, h), j(f, t.utld, h), M(c, br, h));
    let p = M(u, He);
    (M(p, He, p),
        j(p, t.domain, u),
        j(h, t.domain, u),
    ...
    let g = M(s, He),
        y = M(s, ot);
    (M(g, He, g), j(g, t.domain, s), j(y, r, i), j(y, t.domain, s));
    let w = ze(Ao);
    (j(y, t.tld, w),
        j(y, t.utld, w),
        j(w, t.domain, s),
    ...
    let x = ze(Ao),
        S = ze();
    (j(x, e, x), j(x, n, S), j(S, e, x), j(S, n, S), M(w, it, x), M(C, it, x));
    let k = M(l, Bt),
        O = M(a, Bt),
        T = M(O, it),
        A = M(T, it);
    ...
    return (M(o, br, w), M(o, Nl, T0), { start: o, tokens: df });
}
function E0(t, e, n) {
    let r = n.length,
        o = 0,
    ...
    return (s.length > 0 && i.push(wl(rf, e, s)), i);
}
function wl(t, e, n) {
    let r = n[0].s,
        o = n[n.length - 1].e,
...
var N0 = (typeof console < "u" && console && console.warn) || (() => {}),
    O0 =
...
function Ll(t, e = !1) {
    if (
        (Z.initialized &&
            N0(
                `linkifyjs: already initialized - will not register custom scheme "${t}" ${O0}`,
            ),
...
function ri(t) {
    return (
        Z.initialized || R0(),
        E0(Z.parser.start, t, uf(Z.scanner.start, t))
    );
}
ri.scan = uf;
function oi(t, e = null, n = null) {
    ...
    return new P({
        ...
        appendTransaction: (e, n, r) => {
            ...
            let { tr: s } = r,
                l = Js(n.doc, [...e]);
            if (
                (el(l).forEach(({ newRange: c }) => {
                    let d = jd(r.doc, c, (h) => h.isTextblock),
                        u,
                        f;
                    if (d.length > 1)
                        ((u = d[0]),
                    ...
                    if (u && f) {
                        let h = f.split(D0).filter(Boolean);
                        if (h.length <= 0) return !1;
                        let p = h[h.length - 1],
                            m = u.pos + f.lastIndexOf(p);
                        if (!p) return !1;
                        let g = ri(p).map((y) => y.toObject(t.defaultProtocol));
                        if (!L0(g)) return !1;
                        g.filter((y) => y.isLink)
                            .map((y) => ({
                                ...y,
            ...
            handleClick: (e, n, r) => {
                ...
                if (
                    (t.enableClickSelection &&
                        (s = t.editor.commands.extendMarkRange(t.type.name)),
                    t.openOnClick)
                ) {
                    let l = null;
                    ...
                    if (!l) return s;
                    let a = Zs(e.state, t.type.name),
                        c = (o = l?.href) != null ? o : a.href,
                        d = (i = l?.target) != null ? i : a.target;
    ...
    return new P({
        ...
        props: {
            handlePaste: (e, n, r) => {
                ...
                let c = oi(a, { defaultProtocol: t.defaultProtocol }).find(
...
var $0 = ee.create({
        ...
        addOptions() {
            return {
                ...
                isAllowedUri: (t, e) => !!rn(t, e.protocols),
                validate: (t) => !!t,
                shouldAutoLink: (t) => !!t,
            };
        },
        ...
        renderHTML({ HTMLAttributes: t }) {
            return this.options.isAllowedUri(t.href, {
                defaultValidate: (e) => !!rn(e, this.options.protocols),
                protocols: this.options.protocols,
                defaultProtocol: this.options.defaultProtocol,
            })
        ...
        renderMarkdown: (t, e) => {
            var n;
            let r = ((n = t.attrs) == null ? void 0 : n.href) || "";
...
var F0 = Object.defineProperty,
    V0 = (t, e) => {
        for (var n in e) F0(t, n, { get: e[n], enumerable: !0 });
    },
    _0 = "listItem",
    mf = "textStyle",
    gf = /^\s*([-+*])\s$/,
...
`,
        ...
        addInputRules() {
            let t = tt({ find: gf, type: this.type });
            return (
                (this.options.keepMarks || this.options.keepAttributes) &&
                    (t = tt({
                        ...
                        getAttributes: () => this.editor.getAttributes(mf),
                        editor: this.editor,
                    })),
                [t]
            );
...
V0(W0, {
    ...
    hasListBefore: () => xf,
    hasListItemAfter: () => j0,
    hasListItemBefore: () => kf,
    listItemHasSubList: () => Sf,
    nextListIsDeeper: () => Cf,
    nextListIsHigher: () => vf,
});
var xr = (t, e) => {
    ...
    zl = (t, e, n) => {
        ...
        if (!Ze(t.state, e) && xf(t.state, e, n)) {
            ...
            let d = c.at(-1);
            if (!d) return !1;
            let u = t.state.doc.resolve(a.start() + d.pos + 1);
            return t
                .chain()
        ...
        if (!Ze(t.state, e) || !Qd(t.state)) return !1;
        let r = xr(e, t.state);
        if (!r) return !1;
        let i = t.state.doc.resolve(r.$pos.pos - 2).node(r.depth),
            s = Sf(e, t.state, i);
        return kf(e, t.state) && !s
    ...
    Hl = (t, e) => {
        if (!Ze(t.state, e) || !Yd(t.state, e)) return !1;
...
var G0 = "listItem",
    ...
    _l = F.create({
        ...
        renderHTML({ HTMLAttributes: t }) {
            let { start: e, ...n } = t;
            return e === 1
                ? ["ol", R(this.options.HTMLAttributes, n), 0]
                : ["ol", R(this.options.HTMLAttributes, t), 0];
        },
        markdownTokenName: "list",
        parseMarkdown: (t, e) => {
            if (t.type !== "list" || !t.ordered) return [];
            let n = t.start || 1,
                r = t.items ? J0(t.items, e) : [];
            return n !== 1
    ...
    Y0 = F.create({
        ...
        parseMarkdown: (t, e) => {
            ...
            if (
                ...
                let r = e.parseChildren(t.nestedTokens);
                n.push(...r);
            }
        ...
        addExtensions() {
            ...
            return (
                this.options.bulletList !== !1 &&
                    t.push($l.configure(this.options.bulletList)),
                this.options.listItem !== !1 &&
                    t.push(Fl.configure(this.options.listItem)),
                this.options.listKeymap !== !1 &&
                    t.push(U0.configure(this.options.listKeymap)),
                this.options.orderedList !== !1 &&
                    t.push(_l.configure(this.options.orderedList)),
                this.options.taskItem !== !1 &&
                    t.push(Y0.configure(this.options.taskItem)),
                this.options.taskList !== !1 &&
                    t.push(Q0.configure(this.options.taskList)),
                t
            );
        },
    });
var ii = (t, e, n = {}) => {
        ...
        return new P({
            ...
            props: {
                handleDrop(d, u) {
                    ...
                    (ii(d, "form-processing-started", { message: a }),
                        u.preventDefault(),
                        u.stopPropagation());
                    ...
                    return (
                        f.forEach((m, g) => {
                            ...
                            let y = ("10000000-1000-4000-8000" + -1e11).replace(
                                /[018]/g,
                                (w) =>
                                    (
                                        w ^
                ...
                handlePaste(d, u) {
                    if (
                        ...
                        return !1;
                    let f = Array.from(u.clipboardData.files),
                        h = Tf({
                            files: f,
                            acceptedTypes: e,
                            acceptedTypesValidationMessage: n,
    ...
    Af = U.create({
        ...
        addProseMirrorPlugins() {
            return [Z0({ editor: this.editor, ...this.options })];
        },
    });
function ew(t) {
    var e;
    ...
    let y = g.input.slice(Math.max(0, g.index - 1), g.index),
        w = new RegExp(`^[${i?.join("")}\0]?$`).test(y);
    if (i !== null && !w) return null;
    let b = m + g.index,
        C = b + g[0].length;
    return (
        a && d.test(p.slice(C - 1, C + 1)) && ((g[0] += " "), (C += 1)),
        b < l.pos && C >= l.pos
            ? {
                  range: { from: b, to: C },
...
function nw({
    ...
    render: h = () => ({}),
    allow: p = () => !0,
    findSuggestionMatch: m = ew,
}) {
    let g,
        y = h?.(),
        w = () => {
            let S = e.state.selection.$anchor.pos,
                k = e.view.coordsAtPos(S),
                { top: O, right: T, bottom: A, left: $ } = k;
            try {
                return new DOMRect($, O, T - $, A - O);
            } catch {
                return null;
            }
        },
        b = (S, k) =>
            k
                ? () => {
                      let O = t.getState(e.state),
                          T = O?.decorationId,
                          A = S.dom.querySelector(
    ...
    function C(S, k) {
        ...
        try {
            ...
            (O = y?.onExit) == null || O.call(y, z);
        } catch {}
        let T = S.state.tr.setMeta(k, { exit: !0 });
        S.dispatch(T);
    }
    let x = new P({
        key: t,
        view() {
            return {
                update: async (S, k) => {
                    var O, T, A, $, z, K, V;
                    let N = (O = this.key) == null ? void 0 : O.getState(k),
                        _ =
                            (T = this.key) == null
                                ? void 0
                                : T.getState(S.state),
                        W =
                            N.active &&
                            _.active &&
                            N.range.from !== _.range.from,
                        Q = !N.active && _.active,
                        me = N.active && !_.active,
                        Ge = !Q && !me && N.query !== _.query,
                        q = Q || (W && Ge),
                        We = Ge || W,
                        je = me || (W && Ge);
                    if (!q && !We && !je) return;
                    let dn = je && !q ? N : _,
                        aa = S.dom.querySelector(
                            `[data-decoration-id="${dn.decorationId}"]`,
                        );
                    ((g = {
                        editor: e,
                        range: dn.range,
                        ...
                        items: [],
                        command: (ip) =>
                            u({ editor: e, range: dn.range, props: ip }),
                        decorationNode: aa,
                        clientRect: b(S, aa),
                    }),
                        q && ((A = y?.onBeforeStart) == null || A.call(y, g)),
                        We && (($ = y?.onBeforeUpdate) == null || $.call(y, g)),
                        (We || q) &&
                            (g.items = await f({ editor: e, query: dn.query })),
                        je && ((z = y?.onExit) == null || z.call(y, g)),
                        We && ((K = y?.onUpdate) == null || K.call(y, g)),
                        q && ((V = y?.onStart) == null || V.call(y, g)));
                },
                destroy: () => {
                    var S;
        ...
        state: {
            ...
            apply(S, k, O, T) {
                ...
                if (((N.composing = $), A && (K || e.view.composing))) {
                    (V < k.range.from || V > k.range.to) &&
                        !$ &&
                        !k.composing &&
                        (N.active = !1);
                    let W = m({
        ...
        props: {
            handleKeyDown(S, k) {
                var O, T, A, $;
                let { active: z, range: K } = x.getState(S.state);
                if (!z) return !1;
                if (k.key === "Escape" || k.key === "Esc") {
                    let N = x.getState(S.state),
                        _ = (O = g?.decorationNode) != null ? O : null,
                        W =
                            _ ??
                            (N?.decorationId
                                ? S.dom.querySelector(
                    ...
                    let me = {
                        ...
                        items: [],
                        command: (Ge) =>
                            u({ editor: e, range: N.range, props: Ge }),
                        decorationNode: W,
                        clientRect: W
                ...
                return (
                    (($ = y?.onKeyDown) == null
                        ? void 0
                        : $.call(y, { view: S, event: k, range: K })) || !1
                );
            },
            decorations(S) {
                let {
...
var rw = function ({
    ...
    Ef = F.create({
        ...
        addProseMirrorPlugins() {
            return [
                ...this.storage.suggestions.map(si),
                new P({
                    props: {
                        handleDrop(t, e) {
                            if (
...
var Wl = ["top", "right", "bottom", "left"],
    Nf = ["start", "end"],
    jl = Wl.reduce((t, e) => t.concat(e, e + "-" + Nf[0], e + "-" + Nf[1]), []),
    $e = Math.min,
    pe = Math.max,
    Cr = Math.round;
var Ue = (t) => ({ x: t, y: t }),
    ow = { left: "right", right: "left", bottom: "top", top: "bottom" },
...
var sw = new Set(["top", "bottom"]);
function Ke(t) {
    return sw.has(Ne(t)) ? "y" : "x";
}
function ci(t) {
    return Ul(Ke(t));
}
        ...
        s =
            o === "x"
                ...
                : r === "start"
                  ? "bottom"
                  : "top";
    return (e.reference[i] > e.floating[i] && (s = Sr(s)), [s, Sr(s)]);
}
function Df(t) {
    let e = Sr(t);
    return [kr(t), e, kr(e)];
...
function kr(t) {
    return t.replace(/start|end/g, (e) => iw[e]);
}
var Of = ["left", "right"],
    Rf = ["right", "left"],
    lw = ["top", "bottom"],
...
function If(t, e, n, r) {
    let o = Fe(t),
        i = cw(Ne(t), n === "start", r);
    return (
        o && ((i = i.map((s) => s + "-" + o)), e && (i = i.concat(i.map(kr)))),
        i
    );
}
function Sr(t) {
    return t.replace(/left|right|bottom|top/g, (e) => ow[e]);
}
function dw(t) {
        ...
        x = Ct(
            i.convertOffsetParentRelativeRectToViewportRelativeRect
                ? await i.convertOffsetParentRelativeRectToViewportRelativeRect(
                      { elements: l, rect: w, offsetParent: b, strategy: a },
                  )
                : w,
        );
    return {
        top: (y.top - x.top + p.top) / C.y,
        bottom: (x.bottom - y.bottom + p.bottom) / C.y,
        left: (y.left - x.left + p.left) / C.x,
        right: (x.right - y.right + p.right) / C.x,
    };
}
var Hf = (t) => ({
    name: "arrow",
    ...
    async fn(e) {
        ...
        let u = di(d),
            ...
            S = await (s.getOffsetParent == null
                ...
                : s.getOffsetParent(c)),
            k = S ? S[b] : 0;
        (!k || !(await (s.isElement == null ? void 0 : s.isElement(S)))) &&
            (k = l.floating[b] || i.floating[p]);
        let O = C / 2 - x / 2,
            T = k / 2 - m[p] / 2 - 1,
            A = $e(u[y], T),
            $ = $e(u[w], T),
...
function uw(t, e, n) {
    return (
        t
            ? [...n.filter((o) => Fe(o) === t), ...n.filter((o) => Fe(o) !== t)]
            : n.filter((o) => Ne(o) === o)
    ).filter((o) => (t ? Fe(o) === t || (e ? kr(o) !== o : !1) : !0));
}
var $f = function (t) {
        return (
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    let {
                        ...
                        m = u !== void 0 || f === jl ? uw(u || null, h, f) : f,
                        g = await on(e, p),
                        y =
                    ...
                    if (l !== w) return { reset: { placement: m[0] } };
                    let C = [g[Ne(w)], g[b[0]], g[b[1]]],
                        x = [
                            ...(((r = s.autoPlacement) == null
                                ? void 0
                                : r.overflows) || []),
                            { placement: w, overflows: C },
                        ],
                        S = m[y + 1];
                    if (S)
                        return {
            ...
            t === void 0 && (t = {}),
            {
                ...
                async fn(e) {
                    ...
                    let y = Ne(o),
                        ...
                        x = f || (b || !m ? [Sr(l)] : Df(l)),
                        S = p !== "none";
                    !f && S && x.push(...If(l, m, p, C));
                    let k = [l, ...x],
                        O = await on(e, g),
                        T = [],
                        A = ((r = i.flip) == null ? void 0 : r.overflows) || [];
                    if ((d && T.push(O[y]), u)) {
                        let V = Kl(o, s, C);
                        T.push(O[V[0]], O[V[1]]);
                    }
                    if (
                        ((A = [...A, { placement: o, overflows: T }]),
                        !T.every((V) => V <= 0))
                    ) {
                        var $, z;
                        let V =
                                ((($ = i.flip) == null ? void 0 : $.index) ||
                                    0) + 1,
                            N = k[V];
                        if (
                            N &&
                            (!(u === "alignment" ? w !== Ke(N) : !1) ||
                                A.every((Q) =>
                                    Ke(Q.placement) === w
                                        ? Q.overflows[0] > 0
                                        : !0,
                            ...
                            return {
                                data: { index: V, overflows: A },
                                reset: { placement: N },
                            };
                        let _ =
                            (z = A.filter((W) => W.overflows[0] <= 0).sort(
                                (W, Q) => W.overflows[1] - Q.overflows[1],
                            )[0]) == null
                                ? void 0
                                : z.placement;
                        if (!_)
...
var Vf = function (t) {
    return (
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                let { rects: n } = e,
                    { strategy: r = "referenceHidden", ...o } = st(t, e);
                switch (r) {
                    case "referenceHidden": {
                        ...
                        return {
                            data: {
                                ...
                                referenceHidden: Bf(s),
                            },
                        };
                    }
                    case "escaped": {
                        let i = await on(e, { ...o, altBoundary: !0 }),
                            s = Lf(i, n.floating);
                        return { data: { escapedOffsets: s, escaped: Bf(s) } };
                    }
                    default:
                        return {};
                }
...
function _f(t) {
    let e = $e(...t.map((i) => i.left)),
        n = $e(...t.map((i) => i.top)),
        r = pe(...t.map((i) => i.right)),
        o = pe(...t.map((i) => i.bottom));
                ...
                async fn(e) {
                    ...
                    function p() {
                        ...
                        if (u.length >= 2) {
                            ...
                            let g = Ne(n) === "left",
                                y = pe(...u.map((A) => A.right)),
                                w = $e(...u.map((A) => A.left)),
                                b = u.filter((A) =>
                                    g ? A.left === w : A.right === y,
                                ),
                                C = b[0].top,
                                x = b[b.length - 1].bottom,
                                S = w,
                                k = y,
                                O = k - S,
                                T = x - C;
    ...
    return (
        t === void 0 && (t = {}),
        {
            ...
            async fn(e) {
                ...
                await a({ ...e, availableWidth: O, availableHeight: k });
...
function sn(t) {
    return Jf(t) ? (t.nodeName || "").toLowerCase() : "#document";
}
function Ae(t) {
    var e;
    return (
...
function lt(t) {
    var e;
    return (e = (Jf(t) ? t.ownerDocument : t.document) || window.document) ==
        null
        ? void 0
        : e.documentElement;
}
function Jf(t) {
    return fi() ? t instanceof Node || t instanceof Ae(t).Node : !1;
}
function Ve(t) {
    return fi() ? t instanceof Element || t instanceof Ae(t).Element : !1;
}
function qe(t) {
    return fi()
        ? t instanceof HTMLElement || t instanceof Ae(t).HTMLElement
        : !1;
}
function qf(t) {
    return !fi() || typeof ShadowRoot > "u"
        ? !1
        : t instanceof ShadowRoot || t instanceof Ae(t).ShadowRoot;
}
var mw = new Set(["inline", "contents"]);
function Rn(t) {
    let { overflow: e, overflowX: n, overflowY: r, display: o } = _e(t);
    return /auto|scroll|overlay|hidden|clip/.test(e + r + n) && !mw.has(o);
}
var gw = new Set(["table", "td", "th"]);
function Gf(t) {
    return gw.has(sn(t));
}
var yw = [":popover-open", ":modal"];
function vr(t) {
    return yw.some((e) => {
        try {
            return t.matches(e);
...
var bw = ["transform", "translate", "scale", "rotate", "perspective"],
    ww = ["transform", "translate", "scale", "rotate", "perspective", "filter"],
    xw = ["paint", "layout", "strict", "content"];
function hi(t) {
    let e = pi(),
        n = Ve(t) ? _e(t) : t;
    return (
        bw.some((r) => (n[r] ? n[r] !== "none" : !1)) ||
        (n.containerType ? n.containerType !== "normal" : !1) ||
        (!e && (n.backdropFilter ? n.backdropFilter !== "none" : !1)) ||
        (!e && (n.filter ? n.filter !== "none" : !1)) ||
        ww.some((r) => (n.willChange || "").includes(r)) ||
        xw.some((r) => (n.contain || "").includes(r))
    );
}
function Xf(t) {
    let e = vt(t);
...
var kw = new Set(["html", "body", "#document"]);
function ln(t) {
    return kw.has(sn(t));
}
function _e(t) {
...
function vt(t) {
    ...
    let e = t.assignedSlot || t.parentNode || (qf(t) && t.host) || lt(t);
...
function Dn(t) {
    ...
    let n = e.getBoundingClientRect(),
        { width: r, height: o, $: i } = th(e),
        s = (i ? Cr(n.width) : n.width) / r,
        l = (i ? Cr(n.height) : n.height) / o;
    return (
...
function Tr(t, e, n, r) {
    ...
    let o = t.getBoundingClientRect(),
        i = nh(t),
        s = Ue(1);
    e && (r ? Ve(r) && (s = Dn(r)) : (s = Dn(t)));
    let l = Cw(i, n, r) ? rh(i) : Ue(0),
        a = (o.left + l.x) / s.x,
        c = (o.top + l.y) / s.y,
        d = o.width / s.x,
        u = o.height / s.y;
    if (i) {
        ...
        for (; m && r && h !== p; ) {
            let g = Dn(m),
                ...
                w = _e(m),
                b = y.left + (m.clientLeft + parseFloat(w.paddingLeft)) * g.x,
                C = y.top + (m.clientTop + parseFloat(w.paddingTop)) * g.y;
            ((a *= g.x),
                (c *= g.y),
                (d *= g.x),
                (u *= g.y),
    ...
    return Ct({ width: d, height: u, x: a, y: c });
}
function gi(t, e) {
    let n = Mr(t).scrollLeft;
    return e ? e.left + n : Tr(lt(t)).left + n;
}
function oh(t, e) {
    let n = t.getBoundingClientRect(),
        r = n.left + e.scrollLeft - gi(t, n),
        o = n.top + e.scrollTop;
    return { x: r, y: o };
}
function vw(t) {
    ...
    if (
        (u || (!u && !i)) &&
        ((sn(r) !== "body" || Rn(s)) && (a = Mr(r)), qe(r))
    ) {
        let h = Tr(r);
        ((c = Dn(r)), (d.x = h.x + r.clientLeft), (d.y = h.y + r.clientTop));
    }
    let f = s && !u && !i ? oh(s, a) : Ue(0);
    return {
        width: n.width * c.x,
        height: n.height * c.y,
...
function Tw(t) {
    let e = lt(t),
        ...
        o = pe(e.scrollWidth, e.clientWidth, r.scrollWidth, r.clientWidth),
        i = pe(e.scrollHeight, e.clientHeight, r.scrollHeight, r.clientHeight),
        s = -n.scrollLeft + gi(t),
        l = -n.scrollTop;
    return (
        _e(r).direction === "rtl" &&
            (s += pe(e.clientWidth, r.clientWidth) - o),
...
var Ew = new Set(["absolute", "fixed"]);
function Nw(t, e) {
    let n = Tr(t, !0, e === "fixed"),
        r = n.top + t.clientTop,
...
function Zf(t, e, n) {
    let r;
    if (e === "viewport") r = Aw(t, n);
    else if (e === "document") r = Tw(lt(t));
    else if (Ve(e)) r = Nw(e, n);
    else {
        let o = rh(t);
...
function ih(t, e) {
    let n = vt(t);
    return n === e || !Ve(n) || ln(n)
        ? !1
        : _e(n).position === "fixed" || ih(n, e);
}
function Ow(t, e) {
    let n = e.get(t);
    if (n) return n;
    let r = ui(t, [], !1).filter((l) => Ve(l) && sn(l) !== "body"),
        o = null,
        i = _e(t).position === "fixed",
        s = i ? vt(t) : t;
    for (; Ve(s) && !ln(s); ) {
        let l = _e(s),
            a = hi(s);
    ...
    let { element: e, boundary: n, rootBoundary: r, strategy: o } = t,
        ...
        a = s.reduce(
            (c, d) => {
                let u = Zf(e, d, o);
                return (
                    (c.top = pe(u.top, c.top)),
                    (c.right = $e(u.right, c.right)),
                    (c.bottom = $e(u.bottom, c.bottom)),
                    (c.left = pe(u.left, c.left)),
                    c
                );
            },
            Zf(e, l, o),
...
function Iw(t, e, n) {
    ...
    if (r || (!r && !i))
        if (((sn(e) !== "body" || Rn(o)) && (l = Mr(e)), r)) {
            let h = Tr(e, !0, i, e);
            ((a.x = h.x + e.clientLeft), (a.y = h.y + e.clientTop));
        } else o && c();
    i && !r && o && c();
    let d = o && !r && !i ? oh(o, l) : Ue(0),
...
function eh(t, e) {
    if (!qe(t) || _e(t).position === "fixed") return null;
    if (e) return e(t);
...
function sh(t, e) {
    ...
    if (!qe(t)) {
        let o = vt(t);
        for (; o && !ln(o); ) {
            if (Ve(o) && !ql(o)) return o;
            o = vt(o);
        }
        return n;
    }
    let r = eh(t, e);
    for (; r && Gf(r) && ql(r); ) r = eh(r, e);
    return r && ln(r) && ql(r) && !hi(r) ? n : r || Xf(t) || n;
}
var Pw = async function (t) {
    let e = this.getOffsetParent || sh,
        n = this.getDimensions,
        r = await n(t.floating);
    return {
        reference: Iw(t.reference, await e(t.floating), t.strategy),
        ...
        return {
            items: async ({ query: l }) => {
                if (typeof t == "function") {
                    ...
                    try {
                        let c = t({ query: l }),
                            d = Array.isArray(c) ? c : await c;
                        return (s && s.setLoading(!1), d);
                    } catch {
                        return (s && s.setLoading(!1), []);
                    }
                }
                if (!l) return t;
                let a = String(l).toLowerCase();
                return t.filter((c) => {
                    let d =
                        typeof c == "string" ? c : (c?.label ?? c?.name ?? "");
                    return String(d).toLowerCase().includes(a);
                });
            },
            render: () => {
                let l,
                ...
                let u = () => {
                        ...
                        return (
                            ...
                            (b.style.maxHeight = "15rem"),
                            (b.style.minWidth = "12rem"),
                            b
                        );
                    },
                    f = () => {
                        if (!l || !c) return;
                        let b = Array.isArray(c.items) ? c.items : [],
                            C = c.query ?? "";
                        if (((l.innerHTML = ""), d)) {
                            let x = o ?? "Searching...",
                                S = document.createElement("div");
                            S.className = "fi-dropdown-header";
                                ...
                                let k =
                                        typeof x == "string"
                                            ...
                                            : (x?.label ??
                                              x?.name ??
                                              String(x?.id ?? "")),
                                    O = typeof x == "object" ? (x?.id ?? k) : k,
                                    T = document.createElement("button");
                                ((T.className = `fi-dropdown-list-item ${S === a ? "fi-selected" : ""}`),
                                    (T.type = "button"),
                                    T.addEventListener("click", () => p(O, k)));
                                let A = document.createElement("span");
                                ((A.className = "fi-dropdown-list-item-label"),
                                    (A.textContent = k),
                                    T.appendChild(A),
                                    l.appendChild(T));
                            });
                    ...
                    h = (b) => (b ? n : i ? r : e),
                    p = (b, C) => {
                        c && c.command({ id: b, label: C });
                    },
                    m = () => {
                        if (!l || !c || (c.items || []).length === 0) return;
                        let C = l.children[a];
                        if (C) {
                            let x = C.getBoundingClientRect(),
                                S = l.getBoundingClientRect();
                            (x.top < S.top || x.bottom > S.bottom) &&
                    ...
                    g = () => {
                        ...
                        let b = Array.isArray(c.items) ? c.items : [];
                        b.length !== 0 &&
                            ((a = (a + b.length - 1) % b.length), f(), m());
                    },
                    y = () => {
                        if (!c) return;
                        let b = c.items || [];
                        b.length !== 0 && ((a = (a + 1) % b.length), f(), m());
                    },
                    w = () => {
                        let b = c?.items || [];
...
var zw = function ({
        ...
        return {
            ...
            char: o,
            pluginKey: r,
            command: ({ editor: s, range: l, props: a }) => {
                s.view.state.selection.$to.nodeAfter?.text?.startsWith(" ") &&
                    (l.to += 1);
                let u = { ...a, char: o, extra: i };
                (s
                    .chain()
                    .focus()
                    .insertContentAt(l, [
                    ...
                    .run(),
                    s.view.dom.ownerDocument.defaultView
                        ?.getSelection()
                        ?.collapseToEnd());
            },
            allow: ({ state: s, range: l }) => {
                let a = s.doc.resolve(l.from),
                    c = s.schema.nodes[n];
                return !!a.parent.type.contentMatch.matchType(c);
            },
            ...e,
        };
    },
    mh = F.create({
        ...
        addAttributes() {
            return {
                ...
                char: {
                    default: "@",
                    parseHTML: (t) => t.getAttribute("data-char") ?? "@",
                    renderHTML: (t) => (t.char ? { "data-char": t.char } : {}),
                },
                extra: {
                    default: null,
                    renderHTML: (t) => {
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            let n = this.editor?.extensionStorage?.[
                    this.name
        ...
        addProseMirrorPlugins() {
            let t = async (e) => {
                let { state: n, dispatch: r } = e,
                    o = [];
                if (
                    (n.doc.descendants((s, l) => {
                        if (s.type.name !== this.name || s.attrs?.label) return;
                        let a = s.attrs?.id,
                            c = s.attrs?.char ?? "@";
                        a && o.push({ id: a, char: c, pos: l });
                    }),
                    o.length === 0)
                )
                    return;
                let i = this.options.getMentionLabelsUsing;
                if (typeof i == "function")
                    try {
                        let s = o.map(({ id: a, char: c }) => ({
                                id: a,
                                char: c,
                            })),
                            l = await i(s);
                        o.forEach(({ id: a, pos: c }) => {
                            let d = l[a];
                            if (!d) return;
                            let u = e.state.doc.nodeAt(c);
                            if (!u || u.type.name !== this.name) return;
                            let f = { ...u.attrs, label: d },
                                h = e.state.tr.setNodeMarkup(c, void 0, f);
                            r(h);
                        });
                    } catch {}
            };
            ...
            let t = (n) =>
                    Array.isArray(n)
                        ...
                        : n && typeof n == "object"
                          ...
                          : [],
                e = this.options.suggestions.length
                    ? this.options.suggestions
                    : [this.options.suggestion];
            ((this.storage.suggestions = e.map((n) => {
                let r = n?.char ?? "@",
                    o = n?.items ?? [],
                    i = n?.noOptionsMessage ?? null,
                    s = n?.noSearchResultsMessage ?? null,
                    l = n?.isSearchable ?? !1,
                    a = this.options.getMentionSearchResultsUsing,
                    c = n;
                if (typeof n?.items == "function") {
                    ...
                    c = {
                        ...n,
                        items: async (u) => {
                            if (u?.query && typeof a == "function")
                                try {
                                    let f = await a(u?.query, r);
                                    return t(f);
                                } catch {}
                            return await d(u);
                        },
                    ...
                    c = {
                        ...ph({
                            items: async ({ query: h }) => {
                                ...
                                if (!h) return m;
                                let g = String(h).toLowerCase();
                                return m.filter((y) => {
                                    let w =
                                        typeof y == "string"
                                            ? y
                                            : (y?.label ?? y?.name ?? "");
                                    return String(w).toLowerCase().includes(g);
                                });
                            },
                            isSearchable: l,
                            noOptionsMessage: i,
                ...
                (this.storage.getSuggestionFromChar = (n) =>
                    this.storage.suggestions.find((r) => r.char === n) ??
                    this.storage.suggestions[0] ??
                    null));
        },
    });
...
var bh = ee.create({
    ...
    renderHTML({ HTMLAttributes: t }) {
        ...
        let r = t["data-color"],
            i = (this.options.textColors || {})[r],
            s = typeof r == "string" && r.length > 0,
            l = i
                ...
                : s
                  ...
                  : null;
        if (l) {
            let a = typeof t.style == "string" ? t.style : "";
            e.style = a ? `${l}; ${a}` : l;
        }
        return ["span", e, 0];
    },
...
var $w = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/,
    ...
    Vw = ee.create({
        ...
        addInputRules() {
            return [Be({ find: $w, type: this.type })];
        },
        addPasteRules() {
            return [Me({ find: Fw, type: this.type })];
        },
    }),
    wh = Vw;
var _w = ee.create({
...
if (typeof WeakMap < "u") {
    let t = new WeakMap();
    ((Xl = (e) => t.get(e)), (Yl = (e, n) => (t.set(e, n), n)));
} else {
    let t = [],
        n = 0;
    ((Xl = (r) => {
...
function jw(t) {
    ...
    for (let c = 0, d = 0; c < n; c++) {
        ...
        for (let p = 0; ; p++) {
            ...
            let m = u.child(p),
                { colspan: g, rowspan: y, colwidth: w } = m.attrs;
            for (let b = 0; b < y; b++) {
                if (b + c >= n) {
                    (i || (i = [])).push({
...
function Yw(t, e, n) {
    let r = xe(e.type.schema).header_cell;
    for (let o = 0; o < t.height; o++)
        if (e.nodeAt(t.map[n + o * t.width]).type != r) return !1;
    return !0;
}
var X = class Mt extends I {
    constructor(e, n = e) {
        let r = e.node(-1),
            o = oe.get(r),
            i = e.start(-1),
            ...
            l = e.node(0),
            a = o.cellsInRect(s).filter((d) => d != n.pos - i);
        a.unshift(n.pos - i);
        let c = a.map((d) => {
            let u = r.nodeAt(d);
            if (!u) throw new RangeError(`No cell with offset ${d} found`);
            let f = i + d + 1;
            return new yn(l.resolve(f), l.resolve(f + u.content.size));
        });
    ...
    content() {
        ...
        for (let a = o.top; a < o.bottom; a++) {
            ...
            s.push(e.child(a).copy(v.from(c)));
        }
        let l = this.isColSelection() && this.isRowSelection() ? e : s;
        return new E(v.from(l), 1, 1);
    }
    replace(e, n = E.empty) {
        let r = e.steps.length,
            o = this.ranges;
        ...
        let i = I.findFrom(e.doc.resolve(e.mapping.slice(r).map(this.to)), -1);
        i && e.setSelection(i);
    }
    replaceWith(e, n) {
        this.replace(e, new E(v.from(n), 0, 0));
    }
    forEachCell(e) {
    ...
    getBookmark() {
        return new Qw(this.$anchorCell.pos, this.$headCell.pos);
    }
};
...
var Qw = class Ih {
    ...
    map(e) {
        return new Ih(e.map(this.anchor), e.map(this.head));
    }
    resolve(e) {
        let n = e.resolve(this.anchor),
...
function nx(t, e, n) {
    ...
    if (r instanceof L && (s = r.node.type.spec.tableRole)) {
        ...
        r instanceof D && ex(r)
            ...
            : r instanceof D &&
              tx(r) &&
              (i = D.create(o, r.$from.start(), r.$from.end()));
    return (i && (e || (e = t.tr)).setSelection(i), e);
}
var rx = new H("fix-tables");
function Ph(t, e, n, r) {
    let o = t.childCount,
        i = e.childCount;
...
function na(t, e) {
    let n,
        r = (o, i) => {
            o.type.spec.tableRole == "table" && (n = ox(t, o, i, n));
        };
    return (
        e ? e.doc != t.doc && Ph(e.doc, t.doc, 0, r) : t.doc.descendants(r),
        n
    );
}
function ox(t, e, n, r) {
    ...
    for (let a = 0, c = n + 1; a < o.height; a++) {
        ...
        if (f > 0) {
            ...
            let p = [];
            for (let g = 0; g < f; g++) {
                let y = xe(t.schema)[h].createAndFill();
                y && p.push(y);
            }
            let m = (a == 0 || s == a - 1) && l == a ? c + 1 : u - 1;
            r.insert(r.mapping.map(m), p);
        }
        c = u;
    }
    return r.setMeta(rx, { fixTables: !0 });
}
function at(t) {
    let e = t.selection,
        n = Si(t),
...
function Lh(t, { map: e, tableStart: n, table: r }, o) {
    let i = o > 0 ? -1 : 0;
    Yw(e, r, o + i) && (i = o == 0 || o == e.width ? null : 0);
    for (let s = 0; s < e.height; s++) {
        ...
        if (o > 0 && o < e.width && e.map[l - 1] == e.map[l]) {
            ...
            (t.setNodeMarkup(
                t.mapping.map(n + a),
                null,
                Dh(c.attrs, o - e.colCount(a)),
            ),
                (s += c.attrs.rowspan - 1));
        } else {
            let a =
                    i == null
                        ? xe(r.type.schema).cell
...
function ix(t, { map: e, table: n, tableStart: r }, o) {
...
function sx(t, e, n) {
    var r;
    let o = xe(e.type.schema).header_cell;
    for (let i = 0; i < t.width; i++)
        if (
            ((r = e.nodeAt(t.map[i + n * t.width])) === null || r === void 0
                ? void 0
                : r.type) != o
        )
            return !1;
...
function $h(t, { map: e, tableStart: n, table: r }, o) {
    let i = n;
    for (let c = 0; c < o; c++) i += r.child(c).nodeSize;
    let s = [],
        l = o > 0 ? -1 : 0;
    sx(e, r, o + l) && (l = o == 0 || o == e.height ? null : 0);
    for (let c = 0, d = e.width * o; c < e.width; c++, d++)
        if (o > 0 && o < e.height && e.map[d] == e.map[d - e.width]) {
            ...
            let u =
                    l == null
                        ? xe(r.type.schema).cell
                        : (a = r.nodeAt(e.map[d + l * e.width])) === null ||
                            a === void 0
                          ? void 0
                          : a.type,
                f = u?.createAndFill();
    ...
    return (t.insert(i, xe(r.type.schema).row.create(null, s)), t);
}
function Fh(t, e) {
    if (!Je(t)) return !1;
    if (e) {
...
function lx(t, { map: e, table: n, tableStart: r }, o) {
    let i = 0;
...
function _h(t, e) {
    ...
    if (e) {
        ...
        for (let o = n.bottom - 1; lx(r, n, o), o != n.top; o--) {
            let i = n.tableStart ? r.doc.nodeAt(n.tableStart - 1) : r.doc;
            if (!i) throw new RangeError("No table found");
            ((n.table = i), (n.map = oe.get(n.table)));
        }
        e(r);
    }
    return !0;
...
function ax({ width: t, height: e, map: n }, r) {
    ...
    if (e) {
        ...
        for (let d = r.top; d < r.bottom; d++)
            for (let u = r.left; u < r.right; u++) {
                let f = o.map[d * o.width + u],
                    h = r.table.nodeAt(f);
                if (!(s[f] || !h))
                    if (((s[f] = !0), a == null)) ((a = f), (c = h));
                    else {
                        Sh(h) || (l = l.append(h.content));
...
function oa(t, e) {
    let n = xe(t.schema);
    return cx(({ node: r }) => n[r.type.spec.tableRole])(t, e);
}
function cx(t) {
    return (e, n) => {
        let r = e.selection,
        ...
        if (r instanceof X) {
            ...
            var s;
            if (((o = Jw(r.$from)), !o)) return !1;
            i = (s = an(r.$from)) === null || s === void 0 ? void 0 : s.pos;
        }
        if (
            o == null ||
            i == null ||
                ...
                for (let m = d.left, g = 0; m < d.right; m++, g++)
                    (m == d.left && h == d.top) ||
                        u.insert(
                            ...
                            t({ node: o, row: h, col: m }).createAndFill(a[g]),
                        );
            }
...
var cM = Bn("row", { useDeprecatedLogic: !0 }),
    dM = Bn("column", { useDeprecatedLogic: !0 }),
    jh = Bn("cell", { useDeprecatedLogic: !0 });
function ux(t, e) {
    if (e < 0) {
        let n = t.nodeBefore;
...
function ia(t) {
    return function (e, n) {
        ...
        if (n) {
            ...
            n(e.tr.setSelection(D.between(o, Xw(o))).scrollIntoView());
        }
        return !0;
    };
}
...
function yi(t, e) {
    ...
    if (e) {
        let r = t.tr,
            o = xe(t.schema).cell.createAndFill().content;
        (n.forEachCell((i, s) => {
            i.content.eq(o) ||
                r.replace(
                    r.mapping.map(s + 1),
...
function fx(t) {
    ...
    if (i == "row")
        for (let a = 0; a < e.childCount; a++) {
            ...
            ((d || u) && (c = Zl(xe(s).row, new E(c, d, u)).content),
                l.push(c));
        }
    else if (i == "cell" || i == "header_cell")
        l.push(n || r ? Zl(xe(s).row, new E(e, n, r)).content : e);
    else return null;
    return hx(s, l);
}
function hx(t, e) {
    ...
    for (let o = 0; o < n.length; o++)
        if ((o >= e.length && e.push(v.empty), n[o] < r)) {
            let i = xe(t).cell.createAndFill(),
                s = [];
            for (let l = n[o]; l < r; l++) s.push(i);
            e[o] = e[o].append(v.from(s));
        }
    return { height: e.length, width: r, rows: e };
}
function Zl(t, e) {
    let n = t.createAndFill();
    return new Tt(n).replace(0, n.content.size, e).doc;
}
function px({ width: t, height: e, rows: n }, r, o) {
    if (t != r) {
        let i = [],
            s = [];
...
function mx(t, e, n, r, o, i, s) {
    ...
    if (i > e.height) {
        ...
        let f = a.row.create(null, v.from(u)),
            h = [];
...
function Th(t, e, n, r, o) {
    ...
    function h() {
        ...
        ((s = oe.get(i)), (f = u.mapping.maps.length));
    }
    (mx(u, s, i, n, c, d, f) && h(),
        vh(u, s, i, n, a, c, l, f) && h(),
        vh(u, s, i, n, a, c, d, f) && h(),
        Mh(u, s, i, n, l, d, a, f) && h(),
        Mh(u, s, i, n, l, d, c, f) && h());
    for (let p = l; p < d; p++) {
...
function bi(t, e) {
    return (n, r, o) => {
        if (!o) return !1;
        let i = n.selection;
        if (i instanceof X) return xi(n, r, I.near(i.$headCell, e));
        if (t != "horiz" && !i.empty) return !1;
        let s = Kh(o, t, e);
        if (s == null) return !1;
        if (t == "horiz") return xi(n, r, I.near(n.doc.resolve(i.head + e), e));
        {
...
function wi(t, e) {
    return (n, r, o) => {
        ...
        let l = Rh(s.$headCell, t, e);
        return l ? xi(n, r, new X(s.$anchorCell, l)) : !1;
    };
}
function yx(t, e) {
    let n = t.state.doc,
    ...
    if (o instanceof X) {
        r ||
            (r = {
                width: 1,
                height: 1,
                rows: [v.from(Zl(xe(t.state.schema).cell, n))],
            });
        ...
        return (
            (r = px(r, l.right - l.left, l.bottom - l.top)),
            Th(t.state, t.dispatch, s, l, r),
            !0
        );
    } else if (r) {
        let i = Si(t.state),
        ...
        return (
            Th(
                ...
                t.dispatch,
                s,
                oe.get(i.node(-1)).findCell(i.pos - s),
                r,
            ),
            !0
        );
...
function wx(t, e) {
    ...
    if (e.shiftKey && t.state.selection instanceof X)
        ...
        e.shiftKey &&
        r &&
        (o = an(t.state.selection.$anchor)) != null &&
        ((n = Gl(t, e)) === null || n === void 0 ? void 0 : n.pos) != o.pos
    )
        (i(o, e), e.preventDefault());
    else if (!r) return;
    function i(a, c) {
        let d = Gl(t, c),
            u = zt.getState(t.state) == null;
        if (!d || !ta(a, d))
            if (u) d = a;
            else return;
        let f = new X(a, d);
        if (u || !t.state.selection.eq(f)) {
            ...
            (u && h.setMeta(zt, a.pos), t.dispatch(h));
        }
    }
    function s() {
        (t.root.removeEventListener("mouseup", s),
            ...
            zt.getState(t.state) != null &&
                t.dispatch(t.state.tr.setMeta(zt, -1)));
    }
    function l(a) {
        let c = a,
            d = zt.getState(t.state),
            u;
        if (d != null) u = t.state.doc.resolve(d);
        else if (Ah(t, c.target) != r && ((u = Gl(t, e)), !u)) return s();
        u && i(u, c);
    }
...
function Gl(t, e) {
    ...
    return (r >= 0 && an(t.state.doc.resolve(r))) || an(t.state.doc.resolve(o));
}
var xx = class {
    constructor(t, e) {
        ((this.node = t),
            ...
            ea(t, this.colgroup, this.table, e),
    ...
    update(t) {
        return t.type != this.node.type
            ? !1
            : ((this.node = t),
              ea(t, this.colgroup, this.table, this.defaultCellMinWidth),
              !0);
    }
    ignoreMutation(t) {
        return (
...
function ea(t, e, n, r, o, i) {
    ...
    if (c) {
        for (let u = 0, f = 0; u < c.childCount; u++) {
            let { colspan: h, colwidth: p } = c.child(u).attrs;
            for (let m = 0; m < h; m++, f++) {
                let g = o == f ? i : p && p[m],
                    y = g ? g + "px" : "";
                if (((s += g || r), g || (l = !1), a))
                    (a.style.width != y && (a.style.width = y),
                        (a = a.nextSibling));
                else {
                    let w = document.createElement("col");
...
var Oe = new H("tableColumnResizing");
function qh({
    handleWidth: t = 5,
    cellMinWidth: e = 25,
    ...
    let i = new P({
        ...
        props: {
            ...
            decorations: (s) => {
                let l = Oe.getState(s);
                if (l && l.activeHandle > -1) return Nx(s, l.activeHandle);
            },
            nodeViews: {},
        },
    });
...
var kx = class ki {
    ...
    apply(e) {
        let n = this,
            r = e.getMeta(Oe);
        if (r && r.setHandle != null) return new ki(r.setHandle, !1);
        if (r && r.setDragging !== void 0)
            return new ki(n.activeHandle, r.setDragging);
        if (n.activeHandle > -1 && e.docChanged) {
            let o = e.mapping.map(n.activeHandle, -1);
            return (Ql(e.doc.resolve(o)) || (o = -1), new ki(o, n.dragging));
        }
        return n;
    }
};
function Sx(t, e, n, r) {
    ...
    if (o && !o.dragging) {
        ...
        if (i) {
            ...
            e.clientX - l <= n
                ? (s = Eh(t, e, "left", n))
                : a - e.clientX <= n && (s = Eh(t, e, "right", n));
        }
        if (s != o.activeHandle) {
            if (!r && s !== -1) {
...
function Cx(t) {
    if (!t.editable) return;
    let e = Oe.getState(t.state);
    e && e.activeHandle > -1 && !e.dragging && Jh(t, -1);
}
function vx(t, e, n, r) {
    var o;
    if (!t.editable) return !1;
    let i =
            (o = t.dom.ownerDocument.defaultView) !== null && o !== void 0
                ? o
                : window,
        s = Oe.getState(t.state);
    if (!s || s.activeHandle == -1 || s.dragging) return !1;
    let l = t.state.doc.nodeAt(s.activeHandle),
        a = Mx(t, s.activeHandle, l.attrs);
    t.dispatch(
        t.state.tr.setMeta(Oe, {
    ...
    function c(u) {
        ...
        let f = Oe.getState(t.state);
        f?.dragging &&
            (Ax(t, f.activeHandle, Nh(f.dragging, u, n)),
            t.dispatch(t.state.tr.setMeta(Oe, { setDragging: null })));
    }
    function d(u) {
        if (!u.which) return c(u);
        let f = Oe.getState(t.state);
        if (f && f.dragging) {
            let h = Nh(f.dragging, u, n);
            Oh(t, f.activeHandle, h, r);
        }
    }
    return (
        Oh(t, s.activeHandle, a, r),
...
function Mx(t, e, { colspan: n, colwidth: r }) {
    ...
    if (o) return o;
    let i = t.domAtPos(e),
        s = i.node.childNodes[i.offset].offsetWidth,
        l = n;
...
function Eh(t, e, n, r) {
    ...
    if (!i) return -1;
    let { pos: s } = i,
        l = an(t.state.doc.resolve(s));
    if (!l) return -1;
    if (n == "right") return l.pos;
    let a = oe.get(l.node(-1)),
        c = l.start(-1),
...
function Ax(t, e, n) {
    ...
    for (let c = 0; c < i.height; c++) {
        ...
        let p = f.colwidth ? f.colwidth.slice() : Ex(f.colspan);
...
function Oh(t, e, n, r) {
    let o = t.state.doc.resolve(e),
        i = o.node(-1),
        s = o.start(-1),
        l = oe.get(i).colCount(o.pos - s) + o.nodeAfter.attrs.colspan - 1,
        a = t.domAtPos(o.start(-1)).node;
    for (; a && a.nodeName != "TABLE"; ) a = a.parentNode;
    a && ea(i, a.firstChild, a, r, l, n);
}
function Ex(t) {
...
function Nx(t, e) {
    ...
    for (let c = 0; c < i.height; c++) {
        let d = l + c * i.width;
        if (
            (l == i.width - 1 || i.map[d] != i.map[d + 1]) &&
            (c == 0 || i.map[d] != i.map[d - i.width])
        ) {
            var a;
            let u = i.map[d],
                f = s + u + o.nodeAt(u).nodeSize - 1,
                h = document.createElement("div");
            ((h.className = "column-resize-handle"),
                !((a = Oe.getState(t)) === null || a === void 0) &&
                    a.dragging &&
                    n.push(
                        te.node(s + u, s + u + o.nodeAt(u).nodeSize, {
                            class: "column-resize-dragging",
                        }),
                    ),
                n.push(te.widget(f, h)));
        }
    }
    return Y.create(t.doc, n);
}
function Gh({ allowTableNodeSelection: t = !1 } = {}) {
    return new P({
        key: zt,
        state: {
            init() {
        ...
        props: {
            decorations: Zw,
            handleDOMEvents: { mousedown: wx },
            createSelectionBetween(e) {
                return zt.getState(e.state) != null ? e.state.selection : null;
            },
            handleTripleClick: yx,
            handleKeyDown: gx,
            handlePaste: bx,
        },
        appendTransaction(e, n, r) {
            return nx(r, na(r, n), t);
        },
    });
}
var Ox = F.create({
        ...
        for (let f = 0, h = 0; f < d.childCount; f += 1) {
            ...
            for (let g = 0; g < p; g += 1, h += 1) {
                ...
                if (((l += y || r), y || (a = !1), c)) {
                    if (c.style.width !== w) {
                        let [b, C] = sa(r, y);
                        c.style.setProperty(b, C);
                    }
                    c = c.nextSibling;
                } else {
                    let b = document.createElement("col"),
                        [C, x] = sa(r, y);
                    (b.style.setProperty(C, x), e.appendChild(b));
                }
            }
        }
    for (; c; ) {
...
var Ix = class {
    constructor(t, e) {
        ((this.node = t),
            ...
            Xh(t, this.colgroup, this.table, e),
            (this.contentDOM = this.table.appendChild(
                document.createElement("tbody"),
            )));
    }
    update(t) {
        return t.type !== this.node.type
            ? !1
            : ((this.node = t),
              Xh(t, this.colgroup, this.table, this.cellMinWidth),
              !0);
    }
    ignoreMutation(t) {
        let e = t.target,
...
var Ci = ({ editor: t }) => {
        ...
        if (!zx(e)) return !1;
        let n = 0,
            r = Gs(e.ranges[0].$from, (i) => i.type.name === "table");
        return (
...
function Fx(t, e, n = {}) {
    var r;
    let o = (r = n.cellLineSeparator) != null ? r : Hx;
    ...
    i.forEach((p) => {
        var m;
        for (let g = 0; g < s; g += 1) {
            let w = (((m = p[g]) == null ? void 0 : m.text) || "").length;
            (w > l[g] && (l[g] = w), l[g] < 3 && (l[g] = 3));
        }
    });
    let a = (p, m) => p + " ".repeat(Math.max(0, m - p.length)),
        ...
        u = `
`,
        f = new Array(s).fill(0).map((p, m) => (d && c[m] && c[m].text) || "");
    return (
    ...
    _x = F.create({
        ...
        renderHTML({ node: t, HTMLAttributes: e }) {
            let {
                    ...
                    tableWidth: r,
                    tableMinWidth: o,
                } = Px(t, this.options.cellMinWidth),
                i = e.style;
            function s() {
        ...
        addCommands() {
            return {
                insertTable:
                    ...
                    ({ tr: r, dispatch: o, editor: i }) => {
                        let s = Bx(i.schema, t, e, n);
                        if (o) {
                            let l = r.selection.from + 1;
                            r.replaceSelectionWith(s)
                                .scrollIntoView()
                                .setSelection(D.near(r.doc.resolve(l)));
                        }
                        return !0;
                    },
                addColumnBefore:
        ...
        extendNodeSchema(t) {
            ...
            return { tableRole: G(B(t, "tableRole", e)) };
        },
    }),
    Qh = U.create({
        name: "tableKit",
        addExtensions() {
            ...
            return (
                this.options.table !== !1 &&
                    t.push(_x.configure(this.options.table)),
                this.options.tableCell !== !1 &&
                    t.push(Ox.configure(this.options.tableCell)),
                this.options.tableHeader !== !1 &&
                    t.push(Rx.configure(this.options.tableHeader)),
                this.options.tableRow !== !1 &&
                    t.push(Dx.configure(this.options.tableRow)),
                t
            );
        },
    });
...
var np = (t, e) => {
    ...
    rp = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
        items: ({ query: n }) =>
            Object.entries(t)
                .filter(
                    ([r, o]) =>
        ...
        render: () => {
            let n,
                ...
                i = () => {
                    ...
                    return (
                        (f.className = "fi-dropdown-panel fi-dropdown-list"),
                ...
                s = () => {
                    if (!n || !o) return;
                    let f = o.items || [];
                    if (((n.innerHTML = ""), f.length))
                        f.forEach((h, p) => {
                            let m = document.createElement("button");
                            ((m.className = `fi-dropdown-list-item fi-dropdown-list-item-label ${p === r ? "fi-selected" : ""}`),
                                (m.textContent = h.label),
                                (m.type = "button"),
                        ...
                        h.className = "fi-dropdown-header";
                ...
                a = () => {
                    if (!n || !o || o.items.length === 0) return;
                    let f = n.children[r];
                    if (f) {
                ...
                c = () => {
                    ...
                    let f = o.items || [];
                    f.length !== 0 &&
                        ((r = (r + f.length - 1) % f.length), s(), a());
                },
                d = () => {
                    if (!o) return;
                    let f = o.items || [];
                    f.length !== 0 && ((r = (r + 1) % f.length), s(), a());
                },
                u = () => {
                    l(r);
                };
...
var op = async ({
    ...
    canAttachFiles: r,
    customExtensionUrls: o,
    deleteCustomBlockButtonIconHtml: i,
    editCustomBlockButtonIconHtml: s,
    editCustomBlockUsing: l,
    getMentionLabelsUsing: a,
    getMentionSearchResultsUsing: c,
    hasResizableImages: d,
    insertCustomBlockUsing: u,
    key: f,
    linkProtocols: h,
    maxFileSize: p,
    maxFileSizeValidationMessage: m,
    mentions: g,
    mergeTags: y,
    noMergeTagSearchResultsMessage: w,
    placeholder: b,
    statePath: C,
    textColors: x,
    uploadingFileMessage: S,
}) => {
    let k = [
            Du,
            Iu,
            ...
            $u,
            Vu,
            Nu.configure({ class: "fi-not-prose" }),
            Ou,
            _u,
            Wu,
            ju,
            ...
            Yu,
            pf.configure({ autolink: !0, openOnClick: !1, protocols: h }),
            Fl,
            ...(r
                ? [
                      Af.configure({
            ...
            _l,
            gh,
            Jl.configure({ placeholder: b }),
            bh.configure({ textColors: x }),
            yh,
            wh,
            xh,
            kh,
            Qh.configure({ table: { resizable: !0 } }),
            Zh,
            ep.configure({
    ...
    for (let T of O) {
        ...
        let A = k.findIndex(($) => $.name === T.name);
        (T.name === "placeholder" &&
            T.parent === null &&
            (T = Jl.configure(T.options)),
            A !== -1 ? (k[A] = T) : k.push(T));
    }
    return k;
};
...
var qx = class {
        constructor({
            ...
            ((this.preventHide = !1),
                ...
                (this.shouldShow = ({ view: d, state: u, from: f, to: h }) => {
                    let { doc: p, selection: m } = u,
                        { empty: g } = m,
                        y = !p.textBetween(f, h).length && fo(u.selection),
                        w = this.element.contains(document.activeElement);
                    return !(
                        !(d.hasFocus() || w) ||
                        g ||
                        y ||
                ...
                (this.blurHandler = ({ event: d }) => {
                    ...
                    (d?.relatedTarget &&
                        ...
                        (d?.relatedTarget !== this.editor.view.dom &&
                            this.hide());
                }),
                (this.handleDebouncedUpdate = (d, u) => {
                    let f = !u?.selection.eq(d.state.selection),
                        h = !u?.doc.eq(d.state.doc);
                    (!f && !h) ||
            ...
            ((this.editor = t),
                ...
                (this.appendTo = s),
                (this.scrollTarget =
                    (c = a?.scrollTarget) != null ? c : window),
        ...
        get virtualElement() {
            ...
            let { selection: e } = this.editor.state,
                n =
                    (t = this.getReferencedVirtualElement) == null
                        ...
                        : t.call(this);
            if (n) return n;
            let r = tu(this.view, e.from, e.to),
                o = {
            ...
            if (e instanceof X) {
                let { $anchorCell: i, $headCell: s } = e,
                    l = i ? i.pos : s.pos,
                    a = s ? s.pos : i.pos,
                    c = this.view.nodeDOM(l),
...
function Jx({
    ...
    livewireId: m,
    maxFileSize: g,
    maxFileSizeValidationMessage: y,
    mergeTags: w,
    mentions: b,
    getMentionSearchResultsUsing: C,
    getMentionLabelsUsing: x,
    ...
    return {
        ...
        async init() {
            z = new gu({
                ...
                extensions: await op({
                    ...
                    floatingToolbars: l,
                    hasResizableImages: a,
                    insertCustomBlockUsing: (q, We = null) =>
                        this.$wire.mountAction(
                            "customBlock",
                            { id: q, dragPosition: We, mode: "insert" },
                            { schemaComponent: f },
                        ),
                    key: f,
                    linkProtocols: h,
            ...
            let N = "paragraph" in l;
            (Object.keys(l).forEach((q) => {
                let We = this.$refs[`floatingToolbar::${q}`];
                if (!We) {
                    console.warn(`Floating toolbar [${q}] not found.`);
                    return;
                }
                z.registerPlugin(
                    la({
                        editor: z,
                        element: We,
                        pluginKey: `floatingToolbar::${q}`,
                        shouldShow: ({ editor: je }) =>
                            q === "paragraph"
                                ? je.isFocused &&
                                  je.isActive(q) &&
                                  !je.state.selection.empty
                                : N &&
                                    !je.state.selection.empty &&
                                    je.isActive("paragraph")
                                  ? !1
                                  : je.isFocused && je.isActive(q),
            ...
            let _ = Alpine.debounce(() => {
                V || this.$wire.commit();
            }, p ?? 300);
            (z.on("update", ({ editor: q }) =>
                this.$nextTick(() => {
                    V ||
                        ((this.editorUpdatedAt = Date.now()),
                        (this.state = q.getJSON()),
                        (this.shouldUpdateState = !1),
                        (this.fileValidationMessage = null),
                        d && _());
                }),
            ),
                z.on("selectionUpdate", ({ transaction: q }) => {
                    V ||
                        ((this.editorUpdatedAt = Date.now()),
                        (this.editorSelection = q.selection.toJSON()));
                }),
                z.on("transaction", () => {
                ...
                this.$watch("state", () => {
                    if (!V) {
                        ...
                        z.commands.setContent(this.state);
                    }
                }));
            let W = (q) => {
                q.detail.livewireId === m &&
                    q.detail.key === f &&
                    this.runEditorCommands(q.detail);
            };
            (window.addEventListener("run-rich-editor-commands", W),
                K.push(["run-rich-editor-commands", W]));
            let Q = (q) => {
                q.detail.livewireId === m &&
                    q.detail.key === f &&
            ...
            (window.addEventListener("rich-editor-uploading-file", Q),
                K.push(["rich-editor-uploading-file", Q]));
            let me = (q) => {
                q.detail.livewireId === m &&
                    q.detail.key === f &&
                    ((this.isUploadingFile = !1), q.stopPropagation());
            };
            (window.addEventListener("rich-editor-uploaded-file", me),
                K.push(["rich-editor-uploaded-file", me]));
            let Ge = (q) => {
                q.detail.livewireId === m &&
                    q.detail.key === f &&
                    ((this.isUploadingFile = !1),
                    (this.fileValidationMessage = q.detail.validationMessage),
                    q.stopPropagation());
            };
            (window.addEventListener("rich-editor-file-validation-message", Ge),
                K.push(["rich-editor-file-validation-message", Ge]),
                window.dispatchEvent(
                    new CustomEvent(`schema-component-${m}-${f}-loaded`),
                ));
        },
        getEditor() {
            return z;
        ...
        setEditorSelection(N) {
            N &&
                ((this.editorSelection = N),
                z
                    .chain()
                    .command(
                        ({ tr: _ }) => (
                            _.setSelection(
                                I.fromJSON(z.state.doc, this.editorSelection),
                            ),
                            !0
                        ),
                    )
        ...
        runEditorCommands({ commands: N, editorSelection: _ }) {
            this.setEditorSelection(_);
            let W = z.chain();
            (N.forEach((Q) => (W = W[Q.name](...(Q.arguments ?? [])))),
                W.run());
        },
        togglePanel(N = null) {
            if (this.isPanelActive(N)) {
                this.activePanel = null;
                return;
            }
            this.activePanel = N;
        },
        isPanelActive(N = null) {
            return N === null
                ? this.activePanel !== null
                : this.activePanel === N;
        },
        ...
        destroy() {
            ((V = !0),
                K.forEach(([N, _]) => {
                    window.removeEventListener(N, _);
                }),
                (K = []),
                z && (z.destroy(), (z = null)),
                (this.shouldUpdateState = !0));
