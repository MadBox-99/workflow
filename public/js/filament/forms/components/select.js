...
function Et(n) {
    let { x: t, y: e, width: i, height: o } = n;
    return {
        width: i,
        height: o,
        top: e,
...
var ii = async (n, t, e) => {
    let {
        ...
        c = await r.getElementRects({ reference: n, floating: t, strategy: o }),
        { x: f, y: d } = ei(c, i, l),
        p = i,
        u = {},
        g = 0;
...
async function Ie(n, t) {
    var e;
    t === void 0 && (t = {});
    let { x: i, y: o, platform: s, rects: r, elements: a, strategy: l } = n,
        {
        ...
        w =
            d === "floating"
                ...
                : r.reference,
        D = await (s.getOffsetParent == null
            ? void 0
            : s.getOffsetParent(a.floating)),
        A = (await (s.isElement == null ? void 0 : s.isElement(D)))
        ...
        C = Et(
            s.convertOffsetParentRelativeRectToViewportRelativeRect
                ? await s.convertOffsetParentRelativeRectToViewportRelativeRect(
                      { elements: a, rect: w, offsetParent: D, strategy: l },
                  )
                : w,
        );
    return {
        ...
        n === void 0 && (n = {}),
        {
            ...
            async fn(t) {
                ...
                let O = yt(o),
                    ...
                    C = p || (D || !m ? [Bt(a)] : Qe(a)),
                    F = g !== "none";
                !p && F && C.push(...Ze(a, m, g, A));
                let q = [a, ...C],
                    J = await Ie(t, S),
                    _ = [],
                    V = ((i = s.flip) == null ? void 0 : i.overflows) || [];
                if ((f && _.push(J[O]), d)) {
                    let k = Je(o, r, A);
                    _.push(J[k[0]], J[k[1]]);
                }
                if (
                    ((V = [...V, { placement: o, overflows: _ }]),
                    !_.every((k) => k <= 0))
                ) {
                    var W, tt;
                    let k =
                            (((W = s.flip) == null ? void 0 : W.index) || 0) +
                            1,
                        $ = q[k];
                    if (
                        $ &&
                        (!(d === "alignment" ? w !== ht($) : !1) ||
                            V.every((L) =>
                                ht(L.placement) === w ? L.overflows[0] > 0 : !0,
                            ))
                    )
                        return {
                            data: { index: k, overflows: V },
                            reset: { placement: $ },
                        };
                    let B =
                        (tt = V.filter((X) => X.overflows[0] <= 0).sort(
                            (X, L) => X.overflows[1] - L.overflows[1],
                        )[0]) == null
                            ? void 0
                            : tt.placement;
                    if (!B)
...
var nn = new Set(["left", "top"]);
async function on(n, t) {
    let { placement: e, platform: i, elements: o } = n,
        s = await (i.isRTL == null ? void 0 : i.isRTL(o.floating)),
        r = yt(e),
        a = Wt(e),
        l = ht(e) === "y",
        c = nn.has(r) ? -1 : 1,
...
var sn = new Set(["inline", "contents"]);
function It(n) {
    let { overflow: t, overflowX: e, overflowY: i, display: o } = nt(n);
    return /auto|scroll|overlay|hidden|clip/.test(t + i + e) && !sn.has(o);
}
var rn = new Set(["table", "td", "th"]);
function li(n) {
    return rn.has(Ot(n));
}
...
var ln = ["transform", "translate", "scale", "rotate", "perspective"],
    cn = ["transform", "translate", "scale", "rotate", "perspective", "filter"],
...
var fn = new Set(["html", "body", "#document"]);
function Dt(n) {
    return fn.has(Ot(n));
}
function nt(n) {
...
function ut(n) {
    ...
    let t = n.assignedSlot || n.parentNode || (ri(n) && n.host) || ct(n);
...
function ne(n, t, e) {
    ...
    let o = di(n),
        s = o === ((i = n.ownerDocument) == null ? void 0 : i.body),
        r = U(o);
    if (s) {
        let a = ae(r);
        return t.concat(
...
function Tt(n) {
    ...
    let e = t.getBoundingClientRect(),
        { width: i, height: o, $: s } = pi(t),
        r = (s ? Ht(e.width) : e.width) / i,
        a = (s ? Ht(e.height) : e.height) / o;
    return (
    ...
    if (s) {
        ...
        for (; m && i && u !== g; ) {
            let S = Tt(m),
                ...
                w = nt(m),
                D = O.left + (m.clientLeft + parseFloat(w.paddingLeft)) * S.x,
                A = O.top + (m.clientTop + parseFloat(w.paddingTop)) * S.y;
            ((l *= S.x),
                (c *= S.y),
                (f *= S.x),
                (d *= S.y),
...
function le(n, t) {
    let e = Xt(n).scrollLeft;
    return t ? t.left + e : Kt(ct(n)).left + e;
}
function bi(n, t) {
    let e = n.getBoundingClientRect(),
        i = e.left + t.scrollLeft - le(n, e),
        o = e.top + t.scrollTop;
    return { x: i, y: o };
}
function pn(n) {
    let { elements: t, rect: e, offsetParent: i, strategy: o } = n,
        s = o === "fixed",
        r = ct(i),
        a = t ? zt(t.floating) : !1;
    if (i === r || (a && s)) return e;
    ...
    if (
        (d || (!d && !s)) &&
        ((Ot(i) !== "body" || It(r)) && (l = Xt(i)), rt(i))
    ) {
        let u = Kt(i);
        ((c = Tt(i)), (f.x = u.x + i.clientLeft), (f.y = u.y + i.clientTop));
    }
    let p = r && !d && !s ? bi(r, l) : st(0);
    return {
        width: e.width * c.x,
        height: e.height * c.y,
...
function mn(n) {
    let t = ct(n),
        ...
        o = vt(t.scrollWidth, t.clientWidth, i.scrollWidth, i.clientWidth),
        s = vt(t.scrollHeight, t.clientHeight, i.scrollHeight, i.clientHeight),
        r = -e.scrollLeft + le(n),
        a = -e.scrollTop;
    return (
        nt(i).direction === "rtl" &&
    ...
    if (c <= 0) {
        let f = i.ownerDocument,
            ...
            u =
                ...
                0,
            g = Math.abs(i.clientWidth - d.clientWidth - u);
        g <= fi && (s -= g);
    } else c <= fi && (s += c);
    return { width: s, height: r, x: a, y: l };
}
var vn = new Set(["absolute", "fixed"]);
function yn(n, t) {
    let e = Kt(n, !0, t === "fixed"),
        i = e.top + n.clientTop,
...
function Sn(n) {
    let { element: t, boundary: e, rootBoundary: i, strategy: o } = n,
        r = [
            ...(e === "clippingAncestors"
                ? zt(t)
                    ? []
...
function En(n, t, e) {
    ...
    if (i || (!i && !s))
        if (((Ot(t) !== "body" || It(o)) && (a = Xt(t)), i)) {
            let u = Kt(t, !0, s, t);
            ((l.x = u.x + t.clientLeft), (l.y = u.y + t.clientTop));
        } else o && c();
    s && !i && o && c();
    let f = o && !i && !s ? bi(o, a) : st(0),
        d = r.left + a.scrollLeft - l.x - f.x,
        p = r.top + a.scrollTop - l.y - f.y;
...
var On = async function (n) {
    let t = this.getOffsetParent || yi,
        e = this.getDimensions,
        i = await e(n.floating);
    return {
...
var mt = pt(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
    ...
    Ke = pt(/iP(ad|od|hone)/i),
    Mi = pt(/chrome/i) && pt(/android/i),
    Pi = { capture: !1, passive: !1 };
function E(n, t, e) {
...
function kt(n, t, e, i) {
    for (var o = 0, s = 0, r = n.children; s < r.length; ) {
        if (
...
function Rn(n, t) {
    if (n && t) for (var e in t) t.hasOwnProperty(e) && (n[e] = t[e]);
    return n;
}
function _e(n, t) {
    return (
            ...
            if (((n = []), !!this.options.animation)) {
                ...
                i.forEach(function (o) {
                    if (!(b(o, "display") === "none" || o === v.ghost)) {
                        n.push({ target: o, rect: N(o) });
                        var s = ft({}, n[n.length - 1].rect);
...
function Bn(n) {
    ...
    if (((t = t || (e && e[j])), !!t)) {
        var m,
            S = t.options,
            O = "on" + i.charAt(0).toUpperCase() + i.substr(1);
        ...
        var w = ft(ft({}, g), te.getEventProperties(i, t));
        for (var D in w) m[D] = w[D];
...
var h,
    ...
    fe = Ke,
    _i = Zt || mt ? "cssFloat" : "float",
    Hn = Ee && !Mi && !Ke && "draggable" in document.createElement("div"),
    Wi = (function () {
        if (Ee) {
            if (mt) return !1;
    ...
    zi = function (t, e) {
        var i = b(t),
            ...
            c =
                a &&
                parseInt(a.marginLeft) + parseInt(a.marginRight) + N(s).width,
            f =
                l &&
                parseInt(l.marginLeft) + parseInt(l.marginRight) + N(r).width;
        if (i.display === "flex")
    ...
    Xi = function (t) {
        function e(s, r) {
            return function (a, l, c, f) {
                ...
                var p = (r ? a : l).options.group.name;
                return (
                    s === !0 ||
                    (typeof s == "string" && s === p) ||
...
function v(n, t) {
    ...
    var e = {
        ...
        supportPointer:
            v.supportPointer !== !1 && "PointerEvent" in window && (!Gt || Ke),
...
v.prototype = {
    ...
    _emulateDragOver: function () {
        if (at) {
            ((this._lastX = at.clientX), (this._lastY = at.clientY), Ki());
            for (
    ...
    _onDragStart: function (t, e) {
        ...
        (G("setupClone", this),
            ...
            (i.cloneId = me(function () {
                (G("clone", i),
                    !v.eventCanceled &&
                        (i.options.removeCloneOnHide || I.insertBefore(T, h),
                        i._hideClone(),
                        Y({ sortable: i, name: "clone" })));
            })),
            !e && Q(h, s.dragClass, !0),
            e
    ...
    _onDragOver: function (t) {
                ...
                ft(
                    {
                        ...
                        onMove: function (Ge, Gi) {
                            return he(I, e, h, o, Ge, N(Ge), t, Gi);
                        },
                        changed: D,
                    },
                    et,
        ...
        function w(L) {
            return (
                S("dragOverCompleted", { insertion: L }),
                L &&
                ...
                !a.dragoverBubble &&
                    !t.rootEl &&
                    i !== document &&
                    (h.parentNode[j]._isOutsideThisEl(t.target), !L && Ct(t)),
        ...
        if (
            ...
            var A = Ye(e, a.draggable);
            if (!A || ($n(t, u, this) && !A.animated)) {
                if (A === h) return w(!1);
                if (
                    (A && e === t.target && (i = A),
                    i && (s = N(i)),
            ...
            } else if (A && Yn(t, u, this)) {
                var C = kt(e, 0, a, !0);
                if (C === h) return w(!1);
                if (((i = C), (s = N(i)), he(I, e, h, o, i, s, t, !1) !== !1))
                    return (O(), e.insertBefore(h, C), (R = e), D(), w(!0));
                ...
                var F = 0,
                    ...
                    V = u ? "top" : "left",
                    W = Ci(i, "top", "top") || Ci(h, "top", "top"),
                    tt = W ? W.scrollTop : void 0;
                (Rt !== i &&
                    ((q = s[V]), (Qt = !1), (de = (!_ && a.invertSwap) || J)),
                    (F = Un(
                        t,
                        i,
                        s,
                ...
                if (F !== 0) {
                    var k = ot(h);
                    do ((k -= F), (z = R.children[k]));
                    while (z && (b(z, "display") === "none" || z === y));
                }
                if (F === 0 || z === i) return w(!1);
                ((Rt = i), (Jt = F));
                var $ = i.nextElementSibling,
                    B = !1;
                B = F === 1;
                var X = he(I, e, h, o, i, s, t, B);
                if (X !== !1)
                    return (
                        (X === 1 || X === -1) && (B = X === 1),
                        (Ve = !0),
                        ...
                        B && !$
                            ? e.appendChild(h)
                            : i.parentNode.insertBefore(h, B ? $ : i),
                        W && Fi(W, 0, tt - W.scrollTop),
                        (R = h.parentNode),
                        q !== void 0 && !de && (ge = Math.abs(q - N(i)[V])),
                        D(),
                        w(!0)
                    );
            }
        ...
        ((Mt = !1),
            ...
            t &&
                ...
                h &&
                    ...
                    Q(h, this.options.chosenClass, !1),
                    Y({
                        sortable: this,
                        name: "unchoose",
                        toEl: R,
    ...
    option: function (t, e) {
        ...
        var o = te.modifyOption(this, t, e);
        (typeof o < "u" ? (i[t] = o) : (i[t] = e), t === "group" && Xi(i));
    },
    destroy: function () {
        G("destroy", this);
        var t = this.el;
        ...
        if (St) {
            ...
            (h.parentNode == I && !this.options.group.revertClone
                ...
                : Lt
                  ? I.insertBefore(T, Lt)
                  : I.appendChild(T),
                this.options.group.revertClone && this.animate(h, T),
                b(T, "display", ""),
                (St = !1));
        }
    },
...
function Yn(n, t, e) {
    var i = N(kt(e.el, 0, e.options, !0)),
        o = Vi(e.el, e.options, y),
        s = 10;
    return t
...
function $n(n, t, e) {
    var i = N(Ye(e.el, e.options.draggable)),
        o = Vi(e.el, e.options, y),
        s = 10;
    return t
        ? n.clientX > o.right + s ||
...
function Jn() {
    ...
    return (
        (n.prototype = {
            ...
            nulling: function () {
                ((xe = ze = $t = Xe = Ut = Be = Fe = null), (P.length = 0));
            },
        ...
        if (t.scroll) {
            ...
            do {
                ...
                u === l
                    ...
                    : ((C =
                          D < q &&
                          (_.overflowX === "auto" || _.overflowX === "scroll")),
                      (F =
                          A < J &&
                          (_.overflowY === "auto" ||
                              _.overflowY === "scroll")));
                var tt =
                        C &&
                        (Math.abs(w - o) <= r && V + D < q) -
                            (Math.abs(O - o) <= r && !!V),
                    z =
                        F &&
                        (Math.abs(S - s) <= r && W + A < J) -
                            (Math.abs(m - s) <= r && !!W);
                if (!P[d]) for (var k = 0; k <= d; k++) P[k] || (P[k] = {});
                ((P[d].vx != tt || P[d].vy != z || P[d].el !== u) &&
                    ((P[d].el = u),
                    (P[d].vx = tt),
                    (P[d].vy = z),
                    clearInterval(P[d].pid),
                    (tt != 0 || z != 0) &&
                        ((c = !0),
                        (P[d].pid = setInterval(
                            function () {
...
var Oe = class {
    constructor({
        ...
        noSearchResultsMessage: _ = "No results found",
        onStateChange: V = () => {},
        options: W,
        optionsLimit: tt = null,
        placeholder: z,
        position: k = null,
        searchableOptionFields: $ = ["label"],
        searchDebounce: B = 1e3,
        searchingMessage: X = "Searching...",
        searchPrompt: L = "Search...",
        state: et,
        statePath: ee = null,
    }) {
        ((this.canOptionLabelsWrap = t),
            ...
            (this.noSearchResultsMessage = _),
            (this.onStateChange = V),
            (this.options = W),
            (this.optionsLimit = tt),
            (this.originalOptions = JSON.parse(JSON.stringify(W))),
            (this.placeholder = z),
            (this.position = k),
            (this.searchableOptionFields = Array.isArray($) ? $ : ["label"]),
            (this.searchDebounce = B),
                ...
                this.searchInput.addEventListener("keydown", (t) => {
                    if (!this.isDisabled) {
                        if (t.key === "Tab") {
                            ...
                            let i = e.find((s) => {
                                let r =
                                        s.getAttribute("aria-disabled") ===
                                        "true",
                                    a = s.classList.contains("fi-disabled"),
                                    l = s.offsetParent === null;
                                return !(r || a || l);
                            });
                            if (!i) return;
                            let o = i.getAttribute("data-value");
                            if (o === null) return;
                            this.selectOption(o);
                        }
                    }
    ...
    renderOptions() {
        ...
        for (let a of e) {
            ...
            if (a.options && Array.isArray(a.options)) {
                ...
                let l = this.createOptionElement(a.value, a);
                (s.appendChild(l), r++, t++);
            }
        }
        t === 0
    ...
    renderOptionGroup(t, e) {
        ...
        ((s.className = "fi-dropdown-list"),
            e.forEach((r) => {
                let a = this.createOptionElement(r.value, r);
                s.appendChild(a);
            }),
            i.appendChild(o),
            i.appendChild(s),
    ...
    createOptionElement(t, e) {
        ...
        let a = `fi-select-input-option-${Math.random().toString(36).substring(2, 11)}`;
        if (
            ((r.id = a),
            ...
            f.innerHTML = o;
            let d = f.textContent || f.innerText || o;
            r.setAttribute("aria-label", d);
        }
        let l = this.isMultiple
    ...
    async updateSelectedDisplay() {
        ...
        let t = this.selectedDisplayVersion,
        ...
        if (this.isMultiple) {
            if (!Array.isArray(this.state) || this.state.length === 0) {
                ...
                let o = await this.getLabelsForMultipleSelection();
        ...
        let i = await this.getLabelForSingleSelection();
        t === this.selectedDisplayVersion &&
    ...
    createBadgeElement(t, e) {
        ...
        ((i.className =
            ...
            M(t) && i.setAttribute("data-value", t));
        let o = document.createElement("span");
        ...
        ((s.className = "fi-badge-label"),
            ...
            o.appendChild(s),
            i.appendChild(o));
        let r = this.createRemoveButton(t, e);
    ...
    createRemoveButton(t, e) {
        ...
        return (
            ...
            i.addEventListener("click", (o) => {
                (o.stopPropagation(), M(t) && this.selectOption(t));
            }),
            i.addEventListener("keydown", (o) => {
                (o.key === " " || o.key === "Enter") &&
                    (o.preventDefault(),
                    o.stopPropagation(),
                    M(t) && this.selectOption(t));
            }),
            i
        );
    }
    addBadgesForSelectedOptions(t, e = this.selectedDisplay) {
        ...
        ((i.className = "fi-select-input-value-badges-ctn"),
            t.forEach((o, s) => {
                let r = Array.isArray(this.state) ? this.state[s] : null,
                    a = this.createBadgeElement(r, o);
                i.appendChild(a);
            }),
            e.appendChild(i),
            this.isReorderable &&
    ...
    async getLabelForSingleSelection() {
        ...
        if (
            ...
            bt(t) &&
                M(this.initialOptionLabel) &&
                this.state === this.initialState)
        )
            ((t = this.initialOptionLabel),
                M(this.state) && (this.labelRepository[this.state] = t));
    ...
    getSelectedOptionLabel(t) {
        if (M(this.labelRepository[t])) return this.labelRepository[t];
        let e = "";
                ...
                ((this.refreshOptionLabelListener = async (t) => {
                    if (
                        ...
                        try {
                            ...
                            M(e) && (this.labelRepository[this.state] = e);
                            let i = this.selectedDisplay.querySelector(
            ...
            case " ":
                if ((t.preventDefault(), this.isOpen)) {
                    if (this.selectedIndex >= 0) {
                        let e = this.getVisibleOptions()[this.selectedIndex];
                        e && e.click();
                    }
        ...
        switch (t.key) {
            ...
            case "Enter":
                if ((t.preventDefault(), this.selectedIndex >= 0)) {
                    ...
                    let e = this.element.closest("form");
                    e && e.submit();
                }
                break;
            case "Escape":
    ...
    async openDropdown() {
        ...
        if (
            ...
            try {
                let e = await this.getOptionsUsing(),
                    i = Array.isArray(e)
                        ? e
                ...
                if (
                    ...
                    let o = (this.searchInput.value || this.searchQuery || "")
                        .trim()
                        .toLowerCase();
    ...
    scrollOptionIntoView(t) {
        if (!t) return;
        let e = this.dropdown.getBoundingClientRect(),
    ...
    handleSearch(t) {
        ...
        this.searchTimeout = setTimeout(async () => {
            ...
            try {
                ...
                let o = await this.getSearchResultsUsing(e);
    ...
    hideLoadingState() {
        let t = this.dropdown.querySelector(".fi-select-input-message");
        t && t.remove();
    }
    ...
    filterOptions(t) {
        ...
        t = t.toLowerCase();
        let o = [];
        for (let s of this.originalOptions)
            if (s.options && Array.isArray(s.options)) {
                let r = s.options.filter(
                    (a) =>
    ...
    async addSingleBadge(t, e) {
        ...
        bt(i) && (i = t);
        let o = this.createBadgeElement(t, i);
        e.appendChild(o);
    }
