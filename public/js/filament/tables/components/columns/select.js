        ...
        n === void 0 && (n = {}),
        {
            ...
            async fn(t) {
                ...
                let q = [a, ...C],
                    J = await Ie(t, S),
                    R = [],
                    z = ((i = s.flip) == null ? void 0 : i.overflows) || [];
                if ((f && R.push(J[O]), d)) {
                    let F = Je(o, r, A);
                    R.push(J[F[0]], J[F[1]]);
                }
                if (
                    ...
                    var L, Y;
                    let F =
                            (((L = s.flip) == null ? void 0 : L.index) || 0) +
                            1,
                        Q = q[F];
                    if (
                        Q &&
...
var h,
    ...
    Hn = Ee && !Mi && !Xe && "draggable" in document.createElement("div"),
    Wi = (function () {
        if (Ee) {
            if (mt) return !1;
        ...
        if (
            ...
            if (!A || (Yn(t, u, this) && !A.animated)) {
                ...
                var H = 0,
                    ...
                    z = u ? "top" : "left",
                    L = Ci(i, "top", "top") || Ci(h, "top", "top"),
                    Y = L ? L.scrollTop : void 0;
                (Rt !== i &&
...
function Yn(n, t, e) {
    var i = k(Ke(e.el, e.options.draggable)),
        o = Vi(e.el, e.options, y),
        s = 10;
    return t
        ? n.clientX > o.right + s ||
                ...
                var Y =
                    ...
                    B =
                        ...
                        (Math.abs(S - s) <= r && L + A < J) -
                            (Math.abs(m - s) <= r && !!L);
                if (!N[d]) for (var F = 0; F <= d; F++) N[F] || (N[F] = {});
        ...
        init() {
            (d ||
                ...
                this.$watch("state", async (L) => {
                    ...
                    let Y = this.getServerState();
                    if (Y === void 0 || this.getNormalizedState() === Y) return;
                    this.isLoading = !0;
                    let B = await this.$wire.updateTableColumnState(
                        g,
                        C,
                        this.state,
                    );
